...
const translations = {
  tr: {
    hero: {
      ...
      description: "7/24 uzman desteği ile robotlarınızın kesintisiz çalışmasını sağlıyoruz",
    ...
    contact: {
      ...
      formDescription: "Teknik sorunlarınız için detaylı bilgi verin, en kısa sürede size dönüş yapalım.",
      ...
      questions: {
        robotNotWorking: {
          ...
          answer: {
            ...
            conclusion: "Bu adımlar sorunu çözmezse, hata kodları ile birlikte bize ulaşın.",
          },
        },
        calibration: {
          ...
          answer: {
            ...
            conclusion: "Hassasiyet gerektiren işlemlerde daha sık kalibrasyon önerilir.",
          },
        },
        softwareUpdate: {
    ...
    service: {
      ...
      description: "Sahada servis, atölye onarımı veya uzaktan destek için randevu oluşturun.",
      options: {
      ...
      maintenance: {
        ...
        standard: {
          ...
          frequency: "Yıllık",
          features: ["Genel kontrol ve temizlik", "Yazılım güncellemesi", "Temel kalibrasyon"],
        },
        premium: {
          title: "Premium Bakım",
          frequency: "6 Aylık",
      ...
      form: {
        ...
        descriptionPlaceholder: "Yapılacak işlemleri detaylı olarak açıklayın...",
        selectModel: "Model seçin",
  ...
  en: {
    hero: {
      ...
      description: "Ensuring uninterrupted operation of your robots with 24/7 expert support",
      ...
      questions: {
        robotNotWorking: {
          ...
          answer: {
            ...
            conclusion: "If these steps don't solve the problem, contact us with the error codes.",
          },
        },
        calibration: {
          ...
          answer: {
            ...
            conclusion: "More frequent calibration is recommended for precision-requiring operations.",
          },
        },
        softwareUpdate: {
        ...
        warranty: {
          ...
          answer: {
            ...
            conclusion: "Please review your sales contract for warranty details.",
          },
        },
      },
    },
    ...
    service: {
      ...
      description: "Create an appointment for on-site service, workshop repair, or remote support.",
      options: {
        ...
        workshop: {
          ...
          description: "We perform detailed repair of your robot in our workshop",
          duration: "3-7 days",
          badge: "Comprehensive",
        },
        remote: {
      ...
      maintenance: {
        ...
        standard: {
          ...
          frequency: "Annual",
          features: ["General inspection and cleaning", "Software update", "Basic calibration"],
        },
        premium: {
      ...
      form: {
        ...
        descriptionPlaceholder: "Describe the operations to be performed in detail...",
        selectModel: "Select model",
      ...
      <section className="relative bg-gradient-to-br from-blue-600 via-blue-700 to-blue-800 text-white py-20">
        ...
        <div className="relative container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl">
          <div className="text-center">
            ...
            <p className="text-xl md:text-2xl text-blue-100 mb-8 max-w-3xl mx-auto">{t.hero.description}</p>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <h3 className="text-3xl font-bold text-gray-900 mb-2">{t.stats.support247}</h3>
            ...
            <div className="text-center">
              ...
              <h3 className="text-3xl font-bold text-gray-900 mb-2">{t.stats.experts}</h3>
            ...
            <div className="text-center">
              ...
              <h3 className="text-3xl font-bold text-gray-900 mb-2">{t.stats.responseTime}</h3>
                  ...
                  <CardContent>
                    <form onSubmit={handleSupportSubmit} className="space-y-4">
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                          <label className="text-sm font-medium mb-2 block">
                            {t.contact.form.robotModel} {t.contact.form.required}
                          </label>
                          <Select onValueChange={(value) => setSupportForm({ ...supportForm, robotModel: value })}>
                            <SelectTrigger>
                              <SelectValue placeholder={t.contact.form.selectModel} />
                            </SelectTrigger>
                            <SelectContent>
                              <SelectItem value="6-axis-pro">{t.contact.form.models["6-axis-pro"]}</SelectItem>
                              <SelectItem value="scara-x1">{t.contact.form.models["scara-x1"]}</SelectItem>
                              <SelectItem value="delta-speed">{t.contact.form.models["delta-speed"]}</SelectItem>
                              <SelectItem value="cobot-safe">{t.contact.form.models["cobot-safe"]}</SelectItem>
                              <SelectItem value="other">{t.contact.form.models.other}</SelectItem>
                            </SelectContent>
                          </Select>
                        </div>
                        <div>
                          <label className="text-sm font-medium mb-2 block">{t.contact.form.serialNumber}</label>
                          <Input
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                          ...
                          <Select onValueChange={(value) => setSupportForm({ ...supportForm, issueType: value })}>
                            <SelectTrigger>
                              <SelectValue placeholder={t.contact.form.selectIssue} />
                            </SelectTrigger>
                            <SelectContent>
                              <SelectItem value="hardware">{t.contact.form.issues.hardware}</SelectItem>
                              <SelectItem value="software">{t.contact.form.issues.software}</SelectItem>
                              <SelectItem value="calibration">{t.contact.form.issues.calibration}</SelectItem>
                              <SelectItem value="maintenance">{t.contact.form.issues.maintenance}</SelectItem>
                              <SelectItem value="training">{t.contact.form.issues.training}</SelectItem>
                              <SelectItem value="other">{t.contact.form.issues.other}</SelectItem>
                            </SelectContent>
                          </Select>
                        </div>
                        <div>
                          ...
                          <Select onValueChange={(value) => setSupportForm({ ...supportForm, priority: value })}>
                            <SelectTrigger>
                              <SelectValue placeholder={t.contact.form.selectPriority} />
                            </SelectTrigger>
                            <SelectContent>
                              <SelectItem value="critical">{t.contact.form.priorities.critical}</SelectItem>
                              <SelectItem value="high">{t.contact.form.priorities.high}</SelectItem>
                              <SelectItem value="medium">{t.contact.form.priorities.medium}</SelectItem>
                              <SelectItem value="low">{t.contact.form.priorities.low}</SelectItem>
                            </SelectContent>
                          </Select>
                        </div>
                      </div>
                ...
                <div className="space-y-6">
                  <Card>
                    <CardHeader>
                      ...
                      <CardDescription>{t.contact.quickContactDesc}</CardDescription>
                    </CardHeader>
                    <CardContent className="space-y-4">
                      <div className="flex items-center gap-4 p-4 bg-red-50 rounded-lg border border-red-200">
                        ...
                        <div className="flex-1">
                          <h4 className="font-semibold text-red-900">{t.contact.emergency}</h4>
                          <p className="text-red-700">{t.contact.emergencyPhone}</p>
                      ...
                      <div className="flex items-center gap-4 p-4 bg-green-50 rounded-lg border border-green-200">
                        ...
                        <div className="flex-1">
                          <h4 className="font-semibold text-green-900">{t.contact.whatsapp}</h4>
                          <p className="text-green-700">{t.contact.whatsappPhone}</p>
                      ...
                      <div className="flex items-center gap-4 p-4 bg-blue-50 rounded-lg border border-blue-200">
                        ...
                        <div className="flex-1">
                          <h4 className="font-semibold text-blue-900">{t.contact.emailSupport}</h4>
                          <p className="text-blue-700">{t.contact.emailAddress}</p>
                      ...
                      <div className="flex items-center gap-4 p-4 bg-purple-50 rounded-lg border border-purple-200">
                        ...
                        <div className="flex-1">
                          <h4 className="font-semibold text-purple-900">{t.contact.remoteSupport}</h4>
                          <p className="text-purple-700">{t.contact.remoteDesc}</p>
                    ...
                    <CardContent>
                      <div className="space-y-3">
                        ...
                        <div className="flex justify-between items-center">
                          ...
                          <span className="text-orange-600 font-semibold">09:00 - 15:00</span>
                        </div>
                        <div className="flex justify-between items-center">
                          <span className="font-medium">{t.contact.sunday}</span>
                          <span className="text-red-600 font-semibold">{t.contact.emergencyOnly}</span>
                        </div>
                        <div className="pt-2 border-t">
                          <div className="flex justify-between items-center">
                            <span className="font-medium">{t.contact.emergency247}</span>
                      ...
                      <AccordionContent className="text-gray-600">
                        <div className="space-y-3">
                          ...
                          <ul className="list-disc list-inside space-y-1 ml-4">
                            {t.faq.questions.robotNotWorking.answer.steps.map((step, index) => (
                              <li key={index}>{step}</li>
                            ))}
                          </ul>
                          <p>{t.faq.questions.robotNotWorking.answer.conclusion}</p>
                        </div>
                      </AccordionContent>
                    </AccordionItem>
                      ...
                      <AccordionContent className="text-gray-600">
                        <div className="space-y-3">
                          ...
                          <ul className="list-disc list-inside space-y-1 ml-4">
                            <li>
                              <strong>
                                {currentLang === "tr" ? "Yoğun kullanım (24/7):" : "Intensive use (24/7):"}
                              </strong>{" "}
                            ...
                            <li>
                              <strong>{currentLang === "tr" ? "Hafif kullanım:" : "Light use:"}</strong>{" "}
                      ...
                      <AccordionContent className="text-gray-600">
                        <div className="space-y-3">
                          ...
                          <ol className="list-decimal list-inside space-y-1 ml-4">
                            {t.faq.questions.softwareUpdate.answer.steps.map((step, index) => (
                              <li key={index}>{step}</li>
                            ))}
                          </ol>
                          <p className="text-amber-600 font-medium">{t.faq.questions.softwareUpdate.answer.warning}</p>
                        </div>
                      </AccordionContent>
                    </AccordionItem>
                    ...
                    <AccordionItem value="item-4">
                      ...
                      <AccordionContent className="text-gray-600">
                        <div className="space-y-3">
                          ...
                          <ul className="list-disc list-inside space-y-1 ml-4">
                            <li>
                              <strong>{currentLang === "tr" ? "Stokta bulunan parçalar:" : "Parts in stock:"}</strong>{" "}
                              {t.faq.questions.spareParts.answer.inStock}
                            </li>
                            <li>
                              <strong>
                                {currentLang === "tr" ? "Tedarikçiden gelecek parçalar:" : "Parts from supplier:"}
                              </strong>{" "}
                              {t.faq.questions.spareParts.answer.supplier}
                            </li>
                            <li>
                              <strong>
                                {currentLang === "tr" ? "Özel üretim parçalar:" : "Custom manufactured parts:"}
                              </strong>{" "}
                      ...
                      <AccordionContent className="text-gray-600">
                        <div className="space-y-3">
                          ...
                          <ul className="list-disc list-inside space-y-1 ml-4">
                            <li>
                              <strong>
                                {currentLang === "tr" ? "Temel Operatör Eğitimi:" : "Basic Operator Training:"}
                              </strong>{" "}
                              {t.faq.questions.training.answer.basic}
                            </li>
                            <li>
                              <strong>
                                {currentLang === "tr" ? "İleri Seviye Programlama:" : "Advanced Programming:"}
                              </strong>{" "}
                              {t.faq.questions.training.answer.advanced}
                            </li>
                            <li>
                              <strong>{currentLang === "tr" ? "Sahada Eğitim:" : "On-site Training:"}</strong>{" "}
                              {t.faq.questions.training.answer.onsite}
                            </li>
                            <li>
                              <strong>{currentLang === "tr" ? "Online Eğitim:" : "Online Training:"}</strong>{" "}
                    ...
                    <AccordionItem value="item-6">
                      ...
                      <AccordionContent className="text-gray-600">
                        <div className="space-y-3">
                          ...
                          <ul className="list-disc list-inside space-y-1 ml-4">
                            <li>
                              <strong>{currentLang === "tr" ? "Standart Garanti:" : "Standard Warranty:"}</strong>{" "}
                              {t.faq.questions.warranty.answer.standard}
                            </li>
                            <li>
                              <strong>{currentLang === "tr" ? "Genişletilmiş Garanti:" : "Extended Warranty:"}</strong>{" "}
                              {t.faq.questions.warranty.answer.extended}
                            </li>
                            <li>
                              <strong>{currentLang === "tr" ? "Kapsam:" : "Coverage:"}</strong>{" "}
                              {t.faq.questions.warranty.answer.coverage}
                            </li>
                            <li>
                              <strong>{currentLang === "tr" ? "Kapsam Dışı:" : "Excluded:"}</strong>{" "}
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                <Card className="hover:shadow-lg transition-shadow">
                  <CardHeader>
                    <CardTitle className="flex items-center gap-2">
                      ...
                      {t.docs.userManuals.title}
                    </CardTitle>
                    <CardDescription>{t.docs.userManuals.description}</CardDescription>
                  </CardHeader>
                  <CardContent>
                    <div className="space-y-3">
                      <div className="flex items-center justify-between">
                        <span className="text-sm">{t.docs.userManuals.models["6-axis-pro"]}</span>
                        <Button size="sm" variant="outline">
                          <Download className="w-4 h-4 mr-1" />
                          {t.docs.userManuals.download}
                        </Button>
                      </div>
                      <div className="flex items-center justify-between">
                        <span className="text-sm">{t.docs.userManuals.models["scara-x1"]}</span>
                        <Button size="sm" variant="outline">
                          <Download className="w-4 h-4 mr-1" />
                          {t.docs.userManuals.download}
                        </Button>
                      ...
                      <div className="flex items-center justify-between">
                        <span className="text-sm">{t.docs.userManuals.models["delta-speed"]}</span>
                        <Button size="sm" variant="outline">
                          <Download className="w-4 h-4 mr-1" />
                          {t.docs.userManuals.download}
                        </Button>
                ...
                <Card className="hover:shadow-lg transition-shadow">
                  <CardHeader>
                    ...
                    <CardDescription>{t.docs.technical.description}</CardDescription>
                  </CardHeader>
                  <CardContent>
                    <div className="space-y-3">
                      <div className="flex items-center justify-between">
                        <span className="text-sm">{t.docs.technical.installation}</span>
                        <Button size="sm" variant="outline">
                          <Download className="w-4 h-4 mr-1" />
                          {t.docs.userManuals.download}
                        </Button>
                      ...
                      <div className="flex items-center justify-between">
                        <span className="text-sm">{t.docs.technical.maintenance}</span>
                        <Button size="sm" variant="outline">
                          <Download className="w-4 h-4 mr-1" />
                          {t.docs.userManuals.download}
                        </Button>
                      ...
                      <div className="flex items-center justify-between">
                        <span className="text-sm">{t.docs.technical.troubleshooting}</span>
                        <Button size="sm" variant="outline">
                          <Download className="w-4 h-4 mr-1" />
                          {t.docs.userManuals.download}
                        </Button>
                ...
                <Card className="hover:shadow-lg transition-shadow">
                  <CardHeader>
                    <CardTitle className="flex items-center gap-2">
                      ...
                      {t.docs.software.title}
                    </CardTitle>
                    <CardDescription>{t.docs.software.description}</CardDescription>
                  </CardHeader>
                  <CardContent>
                    <div className="space-y-3">
                      <div className="flex items-center justify-between">
                        <span className="text-sm">{t.docs.software.robotStudio}</span>
                        <Button size="sm" variant="outline">
                          <Download className="w-4 h-4 mr-1" />
                          {t.docs.userManuals.download}
                        </Button>
                      ...
                      <div className="flex items-center justify-between">
                        <span className="text-sm">{t.docs.software.simulation}</span>
                        <Button size="sm" variant="outline">
                          <Download className="w-4 h-4 mr-1" />
                          {t.docs.userManuals.download}
                        </Button>
                      ...
                      <div className="flex items-center justify-between">
                        <span className="text-sm">{t.docs.software.calibration}</span>
                        <Button size="sm" variant="outline">
                          <Download className="w-4 h-4 mr-1" />
                          {t.docs.userManuals.download}
                        </Button>
                ...
                <Card className="hover:shadow-lg transition-shadow">
                  <CardHeader>
                    ...
                    <CardDescription>{t.docs.videos.description}</CardDescription>
                  </CardHeader>
                  <CardContent>
                    <div className="space-y-3">
                      <div className="flex items-center justify-between">
                        <span className="text-sm">{t.docs.videos.basicUsage}</span>
                        <Button size="sm" variant="outline">
                      ...
                      <div className="flex items-center justify-between">
                        <span className="text-sm">{t.docs.videos.programming}</span>
                        <Button size="sm" variant="outline">
                          <Video className="w-4 h-4 mr-1" />
                          {t.docs.videos.watch}
                        </Button>
                      ...
                      <div className="flex items-center justify-between">
                        <span className="text-sm">{t.docs.videos.maintenance}</span>
                        <Button size="sm" variant="outline">
                          <Video className="w-4 h-4 mr-1" />
                          {t.docs.videos.watch}
                        </Button>
                ...
                <Card className="hover:shadow-lg transition-shadow">
                  <CardHeader>
                    ...
                    <CardDescription>{t.docs.safety.description}</CardDescription>
                  </CardHeader>
                  <CardContent>
                    <div className="space-y-3">
                      <div className="flex items-center justify-between">
                        <span className="text-sm">{t.docs.safety.safetyRules}</span>
                        <Button size="sm" variant="outline">
                          <Download className="w-4 h-4 mr-1" />
                          {t.docs.userManuals.download}
                        </Button>
                      ...
                      <div className="flex items-center justify-between">
                        <span className="text-sm">{t.docs.safety.riskAssessment}</span>
                        <Button size="sm" variant="outline">
                          <Download className="w-4 h-4 mr-1" />
                          {t.docs.userManuals.download}
                        </Button>
                      ...
                      <div className="flex items-center justify-between">
                        <span className="text-sm">{t.docs.safety.emergencyPlan}</span>
                        <Button size="sm" variant="outline">
                          <Download className="w-4 h-4 mr-1" />
                          {t.docs.userManuals.download}
                        </Button>
                ...
                <Card className="hover:shadow-lg transition-shadow">
                  <CardHeader>
                    <CardTitle className="flex items-center gap-2">
                      ...
                      {t.docs.training.title}
                    </CardTitle>
                    <CardDescription>{t.docs.training.description}</CardDescription>
                  </CardHeader>
                  <CardContent>
                    <div className="space-y-3">
                      <div className="flex items-center justify-between">
                        <span className="text-sm">{t.docs.training.basic}</span>
                        <Button size="sm" variant="outline">
                          <Download className="w-4 h-4 mr-1" />
                          {t.docs.userManuals.download}
                        </Button>
                      ...
                      <div className="flex items-center justify-between">
                        <span className="text-sm">{t.docs.training.advanced}</span>
                        <Button size="sm" variant="outline">
                          <Download className="w-4 h-4 mr-1" />
                          {t.docs.userManuals.download}
                        </Button>
                      ...
                      <div className="flex items-center justify-between">
                        <span className="text-sm">{t.docs.training.certification}</span>
                        <Button size="sm" variant="outline">
                          <Download className="w-4 h-4 mr-1" />
                          {t.docs.userManuals.download}
                        </Button>
                  ...
                  <CardContent>
                    <form onSubmit={handleServiceSubmit} className="space-y-4">
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div>
                          <label className="text-sm font-medium mb-2 block">{t.service.form.company}</label>
                          <Input
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                          <label className="text-sm font-medium mb-2 block">
                            {t.service.form.robotModel} {t.service.form.required}
                          </label>
                          <Select onValueChange={(value) => setServiceForm({ ...serviceForm, robotModel: value })}>
                            <SelectTrigger>
                              <SelectValue placeholder={t.service.form.selectModel} />
                            </SelectTrigger>
                            <SelectContent>
                              <SelectItem value="6-axis-pro">{t.contact.form.models["6-axis-pro"]}</SelectItem>
                              <SelectItem value="scara-x1">{t.contact.form.models["scara-x1"]}</SelectItem>
                        ...
                        <div>
                          <label className="text-sm font-medium mb-2 block">{t.service.form.serialNumber}</label>
                          <Input
                            value={serviceForm.serialNumber}
                            onChange={(e) => setServiceForm({ ...serviceForm, serialNumber: e.target.value })}
                          />
                        </div>
                      </div>
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                          <label className="text-sm font-medium mb-2 block">
                            {t.service.form.serviceType} {t.service.form.required}
                          </label>
                          <Select onValueChange={(value) => setServiceForm({ ...serviceForm, serviceType: value })}>
                            <SelectTrigger>
                              <SelectValue placeholder={t.service.form.selectService} />
                            </SelectTrigger>
                            <SelectContent>
                              <SelectItem value="field">{t.service.form.serviceTypes.field}</SelectItem>
                              <SelectItem value="workshop">{t.service.form.serviceTypes.workshop}</SelectItem>
                              <SelectItem value="remote">{t.service.form.serviceTypes.remote}</SelectItem>
                              <SelectItem value="maintenance">{t.service.form.serviceTypes.maintenance}</SelectItem>
                              <SelectItem value="calibration">{t.service.form.serviceTypes.calibration}</SelectItem>
                              <SelectItem value="training">{t.service.form.serviceTypes.training}</SelectItem>
                            </SelectContent>
                          </Select>
                        </div>
                        <div>
                          <label className="text-sm font-medium mb-2 block">{t.service.form.preferredDate}</label>
                          <Input
                            type="date"
                      ...
                      <div>
                        <label className="text-sm font-medium mb-2 block">{t.service.form.description}</label>
                        <Textarea
                          rows={4}
                ...
                <div className="space-y-6">
                  <Card>
                    <CardHeader>
                      ...
                      <CardDescription>{t.service.options.description}</CardDescription>
                    </CardHeader>
                    <CardContent className="space-y-4">
                      <div className="p-4 border rounded-lg hover:bg-gray-50 transition-colors">
                        <div className="flex items-start gap-3">
                          ...
                          <div className="flex-1">
                            <h4 className="font-semibold text-gray-900">{t.service.options.field.title}</h4>
                            <p className="text-sm text-gray-600 mt-1">{t.service.options.field.description}</p>
                            <div className="flex items-center gap-4 mt-2">
                              <Badge variant="secondary">{t.service.options.field.badge}</Badge>
                              <span className="text-sm text-gray-500">{t.service.options.field.duration}</span>
                            </div>
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="p-4 border rounded-lg hover:bg-gray-50 transition-colors">
                        <div className="flex items-start gap-3">
                          ...
                          <div className="flex-1">
                            <h4 className="font-semibold text-gray-900">{t.service.options.workshop.title}</h4>
                            <p className="text-sm text-gray-600 mt-1">{t.service.options.workshop.description}</p>
                            <div className="flex items-center gap-4 mt-2">
                              <Badge variant="secondary">{t.service.options.workshop.badge}</Badge>
                              <span className="text-sm text-gray-500">{t.service.options.workshop.duration}</span>
                            </div>
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="p-4 border rounded-lg hover:bg-gray-50 transition-colors">
                        <div className="flex items-start gap-3">
                          ...
                          <div className="flex-1">
                            <h4 className="font-semibold text-gray-900">{t.service.options.remote.title}</h4>
                            <p className="text-sm text-gray-600 mt-1">{t.service.options.remote.description}</p>
                            <div className="flex items-center gap-4 mt-2">
                              <Badge variant="secondary">{t.service.options.remote.badge}</Badge>
                              <span className="text-sm text-gray-500">{t.service.options.remote.duration}</span>
                            </div>
                          </div>
                        </div>
                      </div>
                  ...
                  <Card>
                    <CardHeader>
                      ...
                      <CardDescription>{t.service.maintenance.description}</CardDescription>
                    </CardHeader>
                    <CardContent className="space-y-4">
                      <div className="p-4 border rounded-lg">
                        <div className="flex items-center justify-between mb-2">
                          <h4 className="font-semibold">{t.service.maintenance.standard.title}</h4>
                          <Badge variant="outline">{t.service.maintenance.standard.frequency}</Badge>
                        </div>
                        <ul className="text-sm text-gray-600 space-y-1">
                          {t.service.maintenance.standard.features.map((feature, index) => (
                      ...
                      <div className="p-4 border-2 border-blue-200 rounded-lg bg-blue-50">
                        <div className="flex items-center justify-between mb-2">
                          <h4 className="font-semibold text-blue-900">{t.service.maintenance.premium.title}</h4>
                          <Badge className="bg-blue-600">{t.service.maintenance.premium.frequency}</Badge>
                        </div>
                        <ul className="text-sm text-blue-800 space-y-1">
                          {t.service.maintenance.premium.features.map((feature, index) => (
                            <li key={index} className="flex items-center gap-2">
