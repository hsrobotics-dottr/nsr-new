...
const filterCategories = {
  ...
  'İşbirlikçi Robotlar': ['CO Serisi', 'CR Serisi'],
  'Kompozit Robotlar': ['Kompozit Robot', 'AMR Serisi'],
  'Çekirdek Bileşenler': [
...
export default function LibraryPage() {
  ...
  const totalPages =
    filteredData.length === 0
      ? 1
      : Math.ceil(filteredData.length / LIBRARY_CONFIG.ITEMS_PER_PAGE);
  ...
  const getFileIcon = (type: string) => {
    ...
    return (
      <IconComponent className={`w-8 h-8 ${fileType.color.split(' ')[0]}`} />
    );
  };

  const getFileTypeColor = (type: string) => {
    return (
      fileTypes[type as keyof typeof fileTypes]?.color || fileTypes.pdf.color
    );
  };
      ...
      <section className='relative bg-gradient-to-br from-blue-900 via-blue-800 to-blue-900 text-white pt-32 pb-16'>
        ...
        <div className='container mx-auto max-w-8xl relative z-10'>
          <div className='max-w-4xl mx-auto text-center'>
            <h1 className='text-4xl md:text-6xl font-bold mb-6'>Kütüphane</h1>
            <p className='text-xl md:text-2xl text-blue-100 mb-8'>
              Robot dokümantasyonları, 3D modeller ve yazılımlar
            </p>
        ...
        <div className='container mx-auto max-w-8xl'>
          <div className='flex flex-col lg:flex-row gap-8'>
            ...
            <div
              className={`lg:w-80 ${
                isFilterOpen
                  ? 'block fixed inset-x-4 top-24 z-[60] lg:relative lg:inset-auto lg:top-auto'
                  : 'hidden lg:block'
              }`}
            >
                            ...
                            >
                              <Checkbox
                                ...
                                onCheckedChange={checked =>
                                  handleFilterChange(item, checked as boolean)
                                }
                              />
                              <label
                                htmlFor={item}
                    ...
                    <div className='flex items-start space-x-4'>
                      ...
                      <div
                        className={`p-2 rounded-lg ${
                          getFileTypeColor(item.type).split(' ')[1]
                        } shrink-0`}
                      >
