...
{productData.specifications.model}
      ...
      <div
        className='flex justify-between py-2 border-b border-gray-100'>
      <span
        className='text-gray-600 font-medium'>Ekran      </span>
      <span
        className='font-semibold text-gray-800'>
{productData.specifications.display}
      </span>
      ...
      <div
        className='flex justify-between py-2 border-b border-gray-100'>
      <span
        className='text-gray-600 font-medium'>Çözünürlük      </span>
      <span
        className='font-semibold text-gray-800'>
{productData.specifications.resolution}
      </span>
...
{productData.specifications.enableSwitch}
      ...
      <div
        className='flex justify-between py-2 border-b border-gray-100'>
      <span
        className='text-gray-600 font-medium'>USB Arayüzü      </span>
      <span
        className='font-semibold text-gray-800'>
...
{t.product.performance}
      ...
      <div
        className='flex justify-between py-2 border-b border-gray-100'>
      <span
        className='text-gray-600 font-medium'>İşlemci      </span>
      <span
        className='font-semibold text-gray-800'>
{productData.performance.cpu}
      ...
      <div
        className='flex justify-between py-2 border-b border-gray-100'>
      <span
        className='text-gray-600 font-medium'>Bellek      </span>
      <span
        className='font-semibold text-gray-800'>
{productData.performance.memory}
      ...
      <div
        className='flex justify-between py-2 border-b border-gray-100'>
      <span
        className='text-gray-600 font-medium'>Depolama      </span>
      <span
        className='font-semibold text-gray-800'>
{productData.performance.storage}
      ...
      <div
        className='flex justify-between py-2 border-b border-gray-100'>
      <span
        className='text-gray-600 font-medium'>Sistem      </span>
      <span
        className='font-semibold text-gray-800'>
...
{t.product.operating}
      ...
      <div
        className='flex justify-between py-2 border-b border-gray-100'>
      <span
        className='text-gray-600 font-medium'>Giriş Gücü      </span>
      <span
        className='font-semibold text-gray-800'>
...
<div key={index} className='flex items-start space-x-3'>
      <span
        className='text-blue-600 font-bold mt-1'>■      </span>
      <span
