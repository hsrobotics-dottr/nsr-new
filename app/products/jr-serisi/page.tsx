        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-lg text-blue-200 max-w-3xl mx-auto leading-relaxed">
              Yüksek hassasiyet, güvenilirlik ve esneklik sunan JR serisi robotlar,
              çeşitli endüstriyel uygulamalar için optimize edilmiş çözümler sağlar.
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-gray-600 max-w-3xl mx-auto">
                JR serisi robotlar, endüstrinin çeşitli alanlarında yaygın olarak kullanılmaktadır.
              </p>
            </div>
