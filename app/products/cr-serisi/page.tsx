        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl md:text-2xl text-blue-100 mb-8">
              Kompakt Endüstriyel Robotlar
            </p>
            <p className="text-lg text-blue-200 max-w-3xl mx-auto leading-relaxed">
              Kompakt tasarım ve uygun fiyat sunan CR serisi robotlar,
              küçük işletmeler için ideal çözümler sağlar.
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-gray-600 max-w-3xl mx-auto">
                CR serisi robotlar, kompakt endüstriyel uygulamalar için optimize edilmiştir.
              </p>
            </div>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-gray-600 max-w-3xl mx-auto">
                Kompakt endüstriyel uygulamalar için uygun fiyatlı ve güvenilir robotlar.
              </p>
            </div>
      ...
      <section className="py-16 bg-blue-600 text-white">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl text-blue-100 mb-8 max-w-3xl mx-auto">
            Kompakt endüstriyel uygulamalar için uygun fiyatlı çözümler.
          </p>
