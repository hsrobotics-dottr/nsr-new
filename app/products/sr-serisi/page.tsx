...
const srSeriesRobots = [
  {
    ...
    features: ["Yüksek Hız", "Hassas Kontrol", "Kompakt Tasarım"],
    applications: ["Hızlı Montaj", "Kalite Kontrol", "Test İşlemleri"],
  },
  {
    model: "SR-0607-770",
    payload: "7kg",
    ...
    features: ["Yüksek Performans", "Hızlı Döngü", "Esnek Programlama"],
...
const applicationAreas = [
  "Yüksek Hızlı Üretim Hatları - Montaj Otomasyonu",
  "Elektronik Endüstrisi - Hızlı Test ve Montaj",
  "Otomotiv Sektörü - Yüksek Hızlı Montaj",
  "Medikal Cihazlar - Hızlı Paketleme",
  "Telekomünikasyon - Hızlı Bağlantı İşlemleri",
  "Optik Endüstrisi - Hızlı Lens Montajı",
  "Mikroelektronik - Hızlı Çip Test",
  "Fotovoltaik - Hızlı Panel Üretimi",
  "Laboratuvar Otomasyonu - Hızlı Test",
  "İlaç Endüstrisi - Hızlı Tablet İşleme",
]
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl md:text-2xl text-blue-100 mb-8">
              Yüksek Hızlı Endüstriyel Robotlar
            </p>
            <p className="text-lg text-blue-200 max-w-3xl mx-auto leading-relaxed">
              Maksimum hız ve performans sunan SR serisi robotlar,
              yüksek hızlı üretim hatları için özel olarak tasarlanmıştır.
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-gray-600 max-w-3xl mx-auto">
                SR serisi robotlar, yüksek hız gerektiren endüstriyel uygulamalarda tercih edilir.
              </p>
            </div>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-gray-600 max-w-3xl mx-auto">
                Yüksek hız ve performans gerektiren uygulamalar için optimize edilmiş robotlar.
              </p>
            </div>
      ...
      <section className="py-16 bg-blue-600 text-white">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl text-blue-100 mb-8 max-w-3xl mx-auto">
            Yüksek hız uygulamaları için teknik özellikler ve fiyat teklifleri.
          </p>
