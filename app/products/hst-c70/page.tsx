...
const productData = {
  ...
  features: {
    performance: 'Yüksek performanslı işlemci',
            ...
            <div className='space-y-6'>
              ...
              <div className='grid grid-cols-1 sm:grid-cols-3 gap-4'>
                ...
                <Card className='p-4 text-center border-2 border-gray-100'>
                  ...
                  <div className='text-2xl font-bold text-gray-800'>64GB</div>
                </Card>
                <Card className='p-4 text-center border-2 border-gray-100'>
                  <div className='text-sm text-gray-600 mb-1'>
                    {t.product.storage}
                  </div>
                  <div className='text-2xl font-bold text-gray-800'>2TB</div>
                </Card>
              </div>
