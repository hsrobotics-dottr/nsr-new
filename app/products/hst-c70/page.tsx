...
const HSTC70Page = () => {
  ...
  const content = {
    tr: {
      ...
      description:
        'HST-C70 serisi, endüstriyel uygulamalar için özel olarak tasarlanmış güçlü ve güvenilir bilgisayar sistemleridir. Bu seri, zorlu endüstriyel ortamlarda bile kesintisiz çalışma sağlar.',
      features: [
    ...
    en: {
      ...
      description:
        'The HST-C70 series are powerful and reliable computer systems specially designed for industrial applications. This series ensures uninterrupted operation even in challenging industrial environments.',
      features: [
