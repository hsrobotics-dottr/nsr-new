...
keywords: 'HST-C70, hızlı değiştirilen disk, takım değiştirici, HSRobot',
capacity: '70 kg',
material: 'Alüminyum Alaşım',
weight: '3.3 kg',
description:
'HST-C70, 70 kg yük kapasitesine sahip yüksek hassasiyetli hızlı değiştirilen disk sistemidir. Ağır endüstriyel uygulamalar için tasarlanmıştır.',
...
tolerance: '±0.03mm',
loadCapacity: '70 kg',
allowableBendingMoment: '343 N·m',
allowableTorque: '343 N·m',
overallDimension: 'ø155mm',
lockedStateThickness: '68mm',
...
mainDiskWeight: '2 kg',
toolTrayWeight: '1.3 kg',
gasPathChannel: '8',
circuitChannel: '16',
},
features: [
'70 kg yük kapasitesi',
'±0.03mm hassasiyet',
...
export default function HSTC70Page() {
...
{productData.model}
      ...
      <div
        className='flex justify-between py-2 border-b border-gray-100'>
      <span
        className='text-gray-600 font-medium'>Kapasite      </span>
      <span
        className='font-semibold text-gray-800'>
{productData.specifications.capacity}
      </span>
...
Yüzey Pürüzlülüğü
      ...
      <span
        className='font-semibold text-gray-800'>
{productData.specifications.surfaceFinish}
      </span>
      </div>
      <div
        className='flex justify-between py-2 border-b border-gray-100'>
      <span
        className='text-gray-600 font-medium'>Sertlik      </span>
      <span
        className='font-semibold text-gray-800'>
{productData.specifications.hardness}
      </span>
      </div>
      <div
        className='flex justify-between py-2 border-b border-gray-100'>
      <span
        className='text-gray-600 font-medium'>Tolerans      </span>
      <span
        className='font-semibold text-gray-800'>
{productData.specifications.tolerance}
      </span>
      </div>
      </div>
      </Card>
