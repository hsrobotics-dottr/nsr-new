...
// CO Serisi robot modelleri
const coSeriesRobots = [
  {
    model: "CO-0603C-670",
    payload: "3kg",
    reach: "670mm",
      ...
      <section className="relative bg-gradient-to-br from-blue-900 via-blue-800 to-blue-900 text-white pt-20 pb-16">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <h1 className="text-4xl md:text-6xl font-bold mb-6">CO Serisi</h1>
            <p className="text-xl md:text-2xl text-blue-100 mb-8">
              Yüksek Hassasiyetli ve Hızlı Endüstriyel Robotlar
            </p>
            <p className="text-lg text-blue-200 max-w-3xl mx-auto leading-relaxed">
              Maksimum hassasiyet ve hız sunan CO serisi robotlar,
          ...
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-gray-600 max-w-3xl mx-auto">
                CO serisi robotlar, hassasiyet ve hız gerektiren endüstriyel uygulamalarda tercih edilir.
              </p>
            </div>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-7xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {coSeriesRobots.map((robot, index) => (
                <Card
                  key={index}
      ...
      <section className="py-16 bg-blue-600 text-white">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-3xl md:text-4xl font-bold mb-6">
            CO Serisi Hakkında Daha Fazla Bilgi
          </h2>
          <p className="text-xl text-blue-100 mb-8 max-w-3xl mx-auto">
            Yüksek hassasiyet ve hız uygulamaları için teknik özellikler ve fiyat teklifleri.
          </p>
