        ...
        <div className='container mx-auto max-w-8xl relative z-10'>
          <div className='max-w-4xl mx-auto text-center'>
            ...
            <p className='text-lg text-blue-200 max-w-3xl mx-auto leading-relaxed'>
              İnsan-robot işbirliği için özel olarak tasarlanmış CO serisi
          ...
          <div className='max-w-6xl mx-auto'>
            <div className='text-center mb-12'>
              ...
              <p className='text-lg text-gray-600 max-w-3xl mx-auto'>
                CO serisi işbirlikçi robotlar, güvenli insan-robot işbirliği
              ...
              {coSeriesRobots.map((robot, index) => (
                ...
                >
                  ...
                  <CardContent className='space-y-4'>
                    ...
                    <div className='pt-4'>
                      <Link
                        href={`/products/co-series/${robot.model
                          .toLowerCase()
                          .replace(/\//g, '-')
                          .replace(/-/g, '-')}`}
          ...
          <div className='bg-white rounded-2xl shadow-2xl max-w-2xl w-full max-h-[90vh] overflow-y-auto'>
            <div className='p-6 border-b border-gray-200'>
              ...
              <p className='text-gray-600 mt-2'>
                CO Serisi hakkında bilgi almak için formu doldurun.
              </p>
            </div>
              ...
              <form className='space-y-4'>
                ...
                <div>
                  ...
                  <textarea
                    ...
                    rows={4}
                    className='w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent'
                    placeholder='CO Serisi hakkında bilgi almak istiyorum...'
                  />
                </div>
