...
const kompozitRobots = [
  {
    ...
    features: ["Kompozit Malzeme", "Hafif Tasarım", "Yüksek Dayanım"],
    applications: ["Havacılık", "Otomotiv", "Spor Ekipmanları"],
  },
  {
    model: "KR-0607-770",
    payload: "7kg",
    ...
    features: ["Kompozit Yapı", "Hızlı İşlem", "Esnek Programlama"],
    applications: ["Kompozit Montaj", "Laminasyon", "Malzeme Taşıma"],
  },
  {
    model: "KR-0610-900",
    payload: "10kg",
    ...
    features: ["Geniş Çalışma Alanı", "Kompozit Uyumlu", "Dayanıklı Yapı"],
    applications: ["Kompozit İşleme", "CNC Besleme", "Kalıp İşlemleri"],
  },
  {
    model: "KR-0615-1100",
    payload: "15kg",
    ...
    features: ["Yüksek Yük Kapasitesi", "Kompozit Motor", "Endüstriyel Dayanım"],
    applications: ["Ağır Kompozit", "Otomotiv", "Denizcilik"],
  },
]

// Kullanım alanları
const applicationAreas = [
  "Havacılık Endüstrisi - Kompozit Parça Üretimi",
  "Otomotiv Sektörü - Hafif Malzeme Montajı",
  "Denizcilik - Kompozit Tekne Üretimi",
  "Spor Ekipmanları - Kompozit Malzeme İşleme",
  "Rüzgar Enerjisi - Kanat Üretimi",
  "Uzay Endüstrisi - Kompozit Yapılar",
  "Savunma Sanayi - Kompozit Zırh Üretimi",
  "İnşaat Sektörü - Kompozit Malzeme İşleme",
  "Medikal Cihazlar - Hafif Malzeme Montajı",
  "Elektronik - Kompozit Kasa Üretimi",
]
      ...
      <section className="relative bg-gradient-to-br from-blue-900 via-blue-800 to-blue-900 text-white pt-20 pb-16">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <h1 className="text-4xl md:text-6xl font-bold mb-6">Kompozit Robot</h1>
            <p className="text-xl md:text-2xl text-blue-100 mb-8">
              Kompozit Malzeme İşleme Robotları
            </p>
            <p className="text-lg text-blue-200 max-w-3xl mx-auto leading-relaxed">
              Kompozit malzemeler için özel olarak tasarlanmış robotlar,
              hafif ve dayanıklı çözümler sunar.
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-gray-600 max-w-3xl mx-auto">
                Kompozit robotlar, kompozit malzeme işleme gerektiren endüstriyel uygulamalarda tercih edilir.
              </p>
            </div>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-gray-600 max-w-3xl mx-auto">
                Kompozit malzeme işleme için özel olarak tasarlanmış robotlar.
              </p>
            </div>
      ...
      <section className="py-16 bg-blue-600 text-white">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-3xl md:text-4xl font-bold mb-6">
            Kompozit Robot Hakkında Daha Fazla Bilgi
          </h2>
          <p className="text-xl text-blue-100 mb-8 max-w-3xl mx-auto">
            Kompozit malzeme işleme uygulamaları için teknik özellikler ve fiyat teklifleri.
          </p>
