...
const productData = {
model: 'HSR-HC403-590',
category: 'HC Serisi (Endüstriyel Altı Eksenli)',
keywords: 'Endüstriyel Altı Eksenli Robotlar',
axes: 6,
payload: '3 kg',
reach: '590mm',
description: `HSR-HC403-590, Huashu Robotics'den gelen kompakt, çok amaçlı bir robottur ve "yüksek hassasiyet, hafif ağırlık ve yüksek hız" gibi 3C üretiminin yüksek gereksinimlerini karşılar. Tüm makine hafif tasarım kullanır, küçük boyutludur ve esnek kurulum yöntemleri sunar. Bağımsız olarak geliştirilen çekirdek bileşenleri kullanarak, önemli bir maliyet avantajını korurken yüksek performans sergiler. Montaj, paketleme, kalite kontrol ve test işlemleri gibi alanlarda yaygın olarak kullanılır.`,
...
// Additional specifications for HSR-HC403-590
    additionalSpecs: {
...
export default function HSRHC403590Page() {
