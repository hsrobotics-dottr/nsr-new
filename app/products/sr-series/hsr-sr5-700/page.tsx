...
const productData = {
  ...
  payload: '5 kg',
  reach: '700mm',
  description: `HSR-SR5-700, Huashu Robotics'den gelen hassas, çok amaçlı bir robottur ve "yüksek hassasiyet, orta yük kapasitesi ve yüksek hız" gibi hassas üretimin gereksinimlerini karşılar. Tüm makine hafif tasarım kullanır, orta boyutludur ve esnek kurulum yöntemleri sunar. Bağımsız olarak geliştirilen çekirdek bileşenleri kullanarak, önemli bir maliyet avantajını korurken yüksek performans sergiler. Hassas montaj, paketleme, test işlemleri ve kalite kontrol gibi alanlarda yaygın olarak kullanılır.`,
  ...
  // Additional specifications for HSR-SR5-700
  additionalSpecs: {
...
export default function HSRSR5700Page() {
          ...
          <div className='grid lg:grid-cols-2 gap-8'>
            ...
            <Card className='p-6'>
              ...
              <div className='space-y-3'>
                <div className='flex justify-between'>
                  <span className='text-gray-600'>J1:</span>
                  <span className='font-medium'>
                    {productData.movementRange.J1}
                  </span>
                </div>
                <div className='flex justify-between'>
                  <span className='text-gray-600'>J2:</span>
                  <span className='font-medium'>
                    {productData.movementRange.J2}
                  </span>
                </div>
                <div className='flex justify-between'>
                  <span className='text-gray-600'>J3:</span>
                  <span className='font-medium'>
                    {productData.movementRange.J3}
                  </span>
                </div>
                <div className='flex justify-between'>
                  <span className='text-gray-600'>J4:</span>
                  <span className='font-medium'>
                    {productData.movementRange.J4}
                  </span>
                </div>
                <div className='flex justify-between'>
                  <span className='text-gray-600'>J5:</span>
                  <span className='font-medium'>
                    {productData.movementRange.J5}
                  </span>
                </div>
                <div className='flex justify-between'>
                  <span className='text-gray-600'>J6:</span>
                  <span className='font-medium'>
                    {productData.movementRange.J6}
                  </span>
                </div>
              </div>
            </Card>
            ...
            <Card className='p-6'>
              ...
              <div className='space-y-3'>
                <div className='flex justify-between'>
                  <span className='text-gray-600'>J1:</span>
                  <span className='font-medium'>{productData.maxSpeed.J1}</span>
                </div>
                <div className='flex justify-between'>
                  <span className='text-gray-600'>J2:</span>
                  <span className='font-medium'>{productData.maxSpeed.J2}</span>
                </div>
                <div className='flex justify-between'>
                  <span className='text-gray-600'>J3:</span>
                  <span className='font-medium'>{productData.maxSpeed.J3}</span>
                </div>
                <div className='flex justify-between'>
                  <span className='text-gray-600'>J4:</span>
                  <span className='font-medium'>{productData.maxSpeed.J4}</span>
                </div>
                <div className='flex justify-between'>
                  <span className='text-gray-600'>J5:</span>
                  <span className='font-medium'>{productData.maxSpeed.J5}</span>
                </div>
                <div className='flex justify-between'>
                  <span className='text-gray-600'>J6:</span>
                  <span className='font-medium'>{productData.maxSpeed.J6}</span>
                </div>
              </div>
            </Card>
            ...
            <Card className='p-6'>
              ...
              <div className='space-y-3'>
                <div className='flex justify-between'>
                  <span className='text-gray-600'>J4:</span>
                  <span className='font-medium'>
                    {productData.allowedInertia.J4}
                  </span>
                </div>
                <div className='flex justify-between'>
                  <span className='text-gray-600'>J5:</span>
                  <span className='font-medium'>
                    {productData.allowedInertia.J5}
                  </span>
                </div>
                <div className='flex justify-between'>
                  <span className='text-gray-600'>J6:</span>
                  <span className='font-medium'>
                    {productData.allowedInertia.J6}
                  </span>
                </div>
              </div>
            </Card>
            ...
            <Card className='p-6'>
              ...
              <div className='space-y-3'>
                <div className='flex justify-between'>
                  <span className='text-gray-600'>J4:</span>
                  <span className='font-medium'>
                    {productData.allowedTorque.J4}
                  </span>
                </div>
                <div className='flex justify-between'>
                  <span className='text-gray-600'>J5:</span>
                  <span className='font-medium'>
                    {productData.allowedTorque.J5}
                  </span>
                </div>
                <div className='flex justify-between'>
                  <span className='text-gray-600'>J6:</span>
                  <span className='font-medium'>
                    {productData.allowedTorque.J6}
                  </span>
                </div>
              </div>
            </Card>
            ...
            <Card className='p-6'>
              ...
              <div className='space-y-3'>
                ...
                <div className='flex justify-between'>
                  <span className='text-gray-600'>IO Parametreleri:</span>
                  <span className='font-medium'>
                    {productData.additionalSpecs.ioParameters}
                  </span>
                </div>
                <div className='flex justify-between'>
                  <span className='text-gray-600'>Rezerve Sinyal Hatları:</span>
                  <span className='font-medium'>
                    {productData.additionalSpecs.reservedSignalLines}
                  </span>
                </div>
                <div className='flex justify-between'>
                  <span className='text-gray-600'>Rezerve Hava Yolu:</span>
                  <span className='font-medium'>
            ...
            <Card className='p-6'>
              ...
              <div className='space-y-3'>
                <div className='flex justify-between'>
                  <span className='text-gray-600'>Güç Kapasitesi:</span>
                  <span className='font-medium'>
                    {productData.additionalSpecs.powerCapacity}
                  </span>
                </div>
                <div className='flex justify-between'>
                  <span className='text-gray-600'>Anma Gücü:</span>
                  <span className='font-medium'>
                    {productData.additionalSpecs.ratedPower}
                  </span>
                </div>
                <div className='flex justify-between'>
                  <span className='text-gray-600'>Anma Gerilimi:</span>
                  <span className='font-medium'>
                    {productData.additionalSpecs.ratedVoltage}
                  </span>
                </div>
                <div className='flex justify-between'>
                  <span className='text-gray-600'>Anma Akımı:</span>
                  <span className='font-medium'>
                    {productData.additionalSpecs.ratedCurrent}
                  </span>
                </div>
                <div className='flex justify-between'>
                  <span className='text-gray-600'>Koruma Seviyesi:</span>
                  <span className='font-medium'>
                    {productData.additionalSpecs.protectionLevel}
                  </span>
                </div>
                <div className='flex justify-between'>
                  <span className='text-gray-600'>Kurulum Yöntemi:</span>
                  <span className='font-medium'>
      ...
      <section className='py-16 bg-blue-600 text-white'>
        <div className='container mx-auto px-4 max-w-7xl text-center'>
          ...
          <p className='text-xl text-blue-100 mb-8 max-w-3xl mx-auto'>
            {productData.model} hakkında detaylı bilgi almak ve fiyat teklifi
