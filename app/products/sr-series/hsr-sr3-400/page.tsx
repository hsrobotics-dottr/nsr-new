...
payload: '3 kg',
reach: '400mm',
description: `HSR-SR3-400, Huashu Robotics'den gelen ultra hassas, kompakt robottur ve "maksimum hassasiyet, hafif ağırlık ve yüksek hız" gibi hassas üretimin en yüksek gereksinimlerini karşılar. Tüm makine ultra hafif tasarım kullanır, çok küçük boyutludur ve esnek kurulum yöntemleri sunar. Bağımsız olarak geliştirilen çekirdek bileşenleri kullanarak, önemli bir maliyet avantajını korurken maksimum hassasiyet sergiler. Elektronik montaj, hassas test, mikro işlemler ve kalite kontrol gibi alanlarda yaygın olarak kullanılır.`,
...
// Additional specifications for HSR-SR3-400
    additionalSpecs: {
...
export default function HSRSR3400Page() {
