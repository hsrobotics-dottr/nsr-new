            ...
            <Card className='p-6'>
              ...
              <CardContent className='space-y-3'>
                <div className='flex justify-between py-2 border-b border-gray-100'>
                  ...
                  <span className='text-gray-900'>6 kg</span>
                </div>
                <div className='flex justify-between py-2 border-b border-gray-100'>
                  <span className='font-medium text-gray-700'>
                    İzin Verilen Eğilme Momenti
                  </span>
                  <span className='text-gray-900'>30 N·m</span>
                </div>
                <div className='flex justify-between py-2 border-b border-gray-100'>
                  <span className='font-medium text-gray-700'>
                    İzin Verilen Tork
                ...
                <div className='flex justify-between py-2 border-b border-gray-100'>
                  ...
                  <span className='text-gray-900'>ø48mm</span>
                </div>
                <div className='flex justify-between py-2 border-b border-gray-100'>
                  <span className='font-medium text-gray-700'>
                    Kilitli Durum Kalınlığı
                  </span>
                  <span className='text-gray-900'>52mm</span>
                </div>
                <div className='flex justify-between py-2 border-b border-gray-100'>
                  <span className='font-medium text-gray-700'>
                    Tekrarlanan Konumlandırma Hassasiyeti
                  </span>
                  <span className='text-gray-900'>±0.03mm </span>
                </div>
              </CardContent>
            </Card>
            ...
            <Card className='p-6'>
              ...
              <CardContent className='space-y-3'>
                <div className='flex justify-between py-2 border-b border-gray-100'>
                  ...
                  <span className='text-gray-900'>0.4-0.6 MPa </span>
                </div>
                <div className='flex justify-between py-2 border-b border-gray-100'>
                  <span className='font-medium text-gray-700'>
            ...
            <Card className='p-6'>
              ...
              <CardContent className='space-y-3'>
                <div className='flex justify-between py-2 border-b border-gray-100'>
                  ...
                  <span className='text-gray-900'>Alüminyum Alaşım </span>
                </div>
                <div className='flex justify-between py-2 border-b border-gray-100'>
                  <span className='font-medium text-gray-700'>
                    Kilitleme Mekanizması Parçası
                  </span>
                  <span className='text-gray-900'>Alaşım Çelik </span>
                </div>
                <div className='flex justify-between py-2 border-b border-gray-100'>
                  <span className='font-medium text-gray-700'>
                    Ana Disk Ağırlığı
                  </span>
                  <span className='text-gray-900'>230 g </span>
                </div>
                <div className='flex justify-between py-2 border-b border-gray-100'>
                  <span className='font-medium text-gray-700'>
                    Takım Tepsisi Ağırlığı
                  </span>
                  <span className='text-gray-900'>108 g </span>
                </div>
                <div className='flex justify-between py-2 border-b border-gray-100'>
                  <span className='font-medium text-gray-700'>
                    Toplam Ağırlık
                  </span>
                  <span className='text-gray-900'>338 g </span>
                </div>
              </CardContent>
            </Card>
          </div>
