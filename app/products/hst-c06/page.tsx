...
keywords: 'HST-C06, hızlı değiştirilen disk, takım değiştirici, HSRobot',
capacity: '6 kg',
material: 'Alüminyum Alaşım',
weight: '338 g',
description:
'HST-C06, 6 kg yük kapasitesine sahip yüksek hassasiyetli hızlı değiştirilen disk sistemidir. Otomatik üretim hatlarında takım değişim sürelerini minimize ederek üretkenliği artırır.',
...
tolerance: '±0.03mm',
loadCapacity: '6 kg',
allowableBendingMoment: '30 N·m',
allowableTorque: '30 N·m',
overallDimension: 'ø48mm',
lockedStateThickness: '52mm',
repeatedPositioningAccuracy: '±0.03mm',
workingDrivingPressure: '0.4-0.6 MPa',
...
mainDiskWeight: '230 g',
toolTrayWeight: '108 g',
gasPathChannel: '4',
circuitChannel: '9',
},
features: [
...
export default function HSTC06Page() {
...
HST-C06 hızlı değiştirilen disk sisteminin detaylı teknik;
parametreleri
      </p>
      </div>
...
Yük Kapasitesi
      ...
      <span
        className='text-gray-900'>6 kg      </span>
      </div>
      <div
        className='flex justify-between py-2 border-b border-gray-100'>
      <span
...
İzin Verilen Eğilme Momenti
      ...
      <span
        className='text-gray-900'>30 N·m      </span>
      </div>
      <div
        className='flex justify-between py-2 border-b border-gray-100'>
      <span
...
İzin Verilen Tork
      ...
      <span
        className='text-gray-900'>ø48mm      </span>
      </div>
      <div
        className='flex justify-between py-2 border-b border-gray-100'>
      <span
...
Kilitli Durum Kalınlığı
      ...
      <span
        className='text-gray-900'>52mm      </span>
      </div>
      <div
        className='flex justify-between py-2 border-b border-gray-100'>
      <span
...
Tekrarlanan Konumlandırma Hassasiyeti
      ...
      <span
        className='text-gray-900'>±0.03mm      </span>
      </div>
      </CardContent>
      </Card>
...
Çalışma Sürücü Basıncı
      ...
      <span
        className='text-gray-900'>0.4-0.6 MPa      </span>
      </div>
      <div
        className='flex justify-between py-2 border-b border-gray-100'>
      <span
...
Gaz Yolu Kanalları
      ...
      <span
        className='text-gray-900'>4      </span>
      </div>
      <div
        className='flex justify-between py-2 border-b border-gray-100'>
      <span
...
Devre Kanalları
      ...
      <span
        className='text-gray-900'>9      </span>
      </div>
      </CardContent>
      </Card>
...
Ana Disk Ağırlığı
      ...
      <span
        className='text-gray-900'>230 g      </span>
      </div>
      <div
        className='flex justify-between py-2 border-b border-gray-100'>
      <span
...
Takım Tepsisi Ağırlığı
      ...
      <span
        className='text-gray-900'>108 g      </span>
      </div>
      <div
        className='flex justify-between py-2 border-b border-gray-100'>
      <span
...
Toplam Ağırlık
      ...
      <span
        className='text-gray-900'>338 g      </span>
      </div>
      </CardContent>
      </Card>
      </div>
...
Ürün Özellikleri ve Avantajları
      ...
      <p
        className='text-lg text-gray-600 max-w-2xl mx-auto'>
HST-C06'ın sunduğu gelişmiş özellikler ve endüstriyel avantajları
      </p>
      </div>
