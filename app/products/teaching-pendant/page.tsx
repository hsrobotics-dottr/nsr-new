...
// Teaching Pendant ürün verileri;
const teachingPendants = [
  {
    id: 'hspad-03',
    model: 'HsPad-03',
    title: 'Öğretme Cihazı',
    description:
      'Gelişmiş özellikler ile donatılmış, kullanıcı dostu öğretme cihazı',
    image: '/img/teaching/HsPad-03.png',
    specs: {
      type: 'Öğretme Cihazı',
      display: '7" Dokunmatik',
      battery: '8 Saat',
      weight: '0.8 kg',
    },
    features: ['Dokunmatik Ekran', 'Uzun Pil Ömrü', 'Kolay Kullanım'],
    applications: [
      'Robot Programlama',
...
export default function TeachingPendantPage() {
        ...
        <div className='container mx-auto max-w-8xl relative z-10'>
          <div className='max-w-4xl mx-auto text-center'>
            ...
            <p className='text-xl md:text-2xl text-blue-100 mb-8'>
              Gelişmiş Öğretme Cihazları ve Programlama Sistemleri
            </p>
            <p className='text-lg text-blue-200 max-w-3xl mx-auto leading-relaxed'>
              Robot programlama ve endüstriyel otomasyon için kullanıcı dostu
              öğretme cihazı çözümleri.
            </p>
          </div>
        </div>
      </section>
          ...
          <div className='max-w-7xl mx-auto'>
            <div className='text-center mb-12'>
              <h2 className='text-3xl md:text-4xl font-bold text-gray-800 mb-6'>
                Öğretme Cihazı Ürün Modelleri
              </h2>
              <p className='text-lg text-gray-600 max-w-3xl mx-auto'>
                Robot programlama ve otomasyon için gelişmiş öğretme cihazı
                çözümleri.
              </p>
            </div>

            <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8'>
              {teachingPendants.map((pendant, index) => (
                <Card
                  key={index}
                  ...
                  <CardContent className='space-y-4'>
                    <div className='grid grid-cols-2 gap-3'>
                      <div className='bg-blue-100 p-3 rounded-lg text-center'>
                        <div className='text-xs text-gray-600 mb-1'>Ekran</div>
                        <div className='text-sm font-bold text-blue-700'>
                          {pendant.specs.display}
                        </div>
                      </div>
      ...
      <section className='py-16 bg-blue-600 text-white'>
        <div className='container mx-auto px-4 max-w-7xl text-center'>
          <h2 className='text-3xl md:text-4xl font-bold mb-6'>
            Öğretme Cihazı Hakkında Daha Fazla Bilgi
          </h2>
          ...
          <div className='bg-white rounded-2xl shadow-2xl max-w-2xl w-full max-h-[90vh] overflow-y-auto'>
            <div className='p-6 border-b border-gray-200'>
              ...
              <p className='text-gray-600 mt-2'>
                Öğretme Cihazı ürünleri hakkında bilgi almak için formu
                doldurun.
              </p>
            </div>
              ...
              <form className='space-y-4'>
                ...
                <div>
                  ...
                  <textarea
                    ...
                    rows={4}
                    className='w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent'
                    placeholder='Öğretme Cihazı ürünleri hakkında bilgi almak istiyorum...'
                  ></textarea>
                </div>
