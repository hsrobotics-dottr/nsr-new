            ...
            <div className='space-y-6'>
              ...
              <div className='grid grid-cols-1 sm:grid-cols-3 gap-4'>
                <Card className='p-4 text-center border-2 border-blue-100 bg-blue-50'>
                  <div className='text-sm text-gray-600 mb-1'>Güç</div>
                  <div className='text-2xl font-bold text-blue-600'>
                    {productData.power}
                  </div>
                </Card>
                <Card className='p-4 text-center border-2 border-gray-100'>
                  <div className='text-sm text-gray-600 mb-1'>Ağırlık</div>
                  <div className='text-2xl font-bold text-gray-800'>
                    {productData.weight}
                  </div>
                </Card>
                <Card className='p-4 text-center border-2 border-gray-100'>
                  <div className='text-sm text-gray-600 mb-1'>Maksimum Hız</div>
                  <div className='text-2xl font-bold text-gray-800'>
          ...
          <div className='grid lg:grid-cols-2 gap-8'>
            ...
            <Card className='p-6'>
              ...
              <div className='space-y-3'>
                ...
                <div className='flex justify-between py-2 border-b border-gray-100'>
                  <span className='text-gray-600 font-medium'>Güç</span>
                  <span className='font-semibold text-gray-800'>
                    {productData.power}
                  </span>
                </div>
                ...
                <div className='flex justify-between py-2 border-b border-gray-100'>
                  ...
                  <span className='font-semibold text-gray-800'>7-30N</span>
                </div>
              </div>
            </Card>
