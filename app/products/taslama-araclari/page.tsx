...
// Taşlama araçları ürün modelleri;
const taslamaAraclariProducts = [
  {
    model: 'HST-M-RC350',
    title: 'Taşlama Aracı',
    ...
    features: ['Yüksek Güçlü Taşlama', 'Hassas Hız Kontrolü', 'Dayanıklı Yapı'],
    applications: ['Metal İşleme', 'Taşlama', 'Cilalama'],
  },
];

export default function TaslamaAraclariPage() {
        ...
        <div className='container mx-auto max-w-8xl relative z-10'>
          <div className='max-w-4xl mx-auto text-center'>
            ...
            <p className='text-xl md:text-2xl text-blue-100 mb-8'>
              Endüstriyel Taşlama ve Cilalama Çözümleri
            </p>
            <p className='text-lg text-blue-200 max-w-3xl mx-auto leading-relaxed'>
              Yüksek performanslı taşlama araçları, metal işleme ve yüzey işleme
              operasyonları için optimize edilmiş çözümler sunar. Hassas hız
              kontrolü ve dayanıklı yapı ile uzun ömürlü kullanım.
            </p>
          </div>
        </div>
      </section>
          ...
          <div className='max-w-7xl mx-auto'>
            <div className='text-center mb-12'>
              <h2 className='text-3xl md:text-4xl font-bold text-gray-800 mb-6'>
                Taşlama Aracı Modelleri
              </h2>
              <p className='text-lg text-gray-600 max-w-3xl mx-auto'>
                Farklı güç ve hız seviyeleri ile ihtiyaçlarınıza uygun taşlama
                aracı seçimi yapın.
              </p>
            </div>

            <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8'>
              {taslamaAraclariProducts.map((product, index) => (
                <Card
                  key={index}
                ...
                >
                  ...
                  <CardContent className='space-y-4'>
                    ...
                    <div className='pt-4'>
                      <Link
                        href='/products/taslama-araclari/hst-m-rc350'
      ...
      <section className='py-16 bg-blue-600 text-white'>
        <div className='container mx-auto max-w-8xl text-center'>
          <h2 className='text-3xl md:text-4xl font-bold mb-6'>
            Taşlama Araçları Hakkında Daha Fazla Bilgi
          </h2>
          ...
          <div className='bg-white rounded-2xl shadow-2xl max-w-2xl w-full max-h-[90vh] overflow-y-auto'>
            <div className='p-6 border-b border-gray-200'>
              ...
              <p className='text-gray-600 mt-2'>
                Taşlama araçları hakkında bilgi almak için formu doldurun.
              </p>
            </div>
              ...
              <form className='space-y-4'>
                ...
                <div>
                  ...
                  <textarea
                    ...
                    rows={4}
                    className='w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent'
                    placeholder='Taşlama araçları hakkında bilgi almak istiyorum...'
                  ></textarea>
                </div>
