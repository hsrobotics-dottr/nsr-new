...
const jhSeriesRobots = [
  {
    ...
    features: ["Yüksek Hassasiyet", "Hızlı Döngü", "Kompakt Tasarım"],
    applications: ["Hassas Montaj", "Kalite Kontrol", "Test İşlemleri"],
  },
  {
    model: "JH-0607-770",
    payload: "7kg",
    ...
    features: ["Yüksek Hız", "Hassas Kontrol", "Esnek Programlama"],
    applications: ["Elektronik Montaj", "Lazer İşleme", "Malzeme Taşıma"],
  },
  {
    model: "JH-0610-900",
    payload: "10kg",
  ...
  },
  {
    ...
    payload: "20kg",
    reach: "1300mm",
    image: "https://omo-oss-image.thefastimg.com/portal-saas/pg2024072219142686656/cms/image/858bc62d-74c4-49f3-be26-614c38d8bb81.png",
    specs: {
      dof: "6 Eksen",
      repeatability: "±0.1mm",
      maxSpeed: "2.2 m/s",
...
const applicationAreas = [
  "Elektronik Endüstrisi - Hassas Montaj ve Test",
  "Otomotiv Sektörü - Yüksek Hızlı Montaj",
  "Medikal Cihazlar - Steril Ortam Uygulamaları",
  "Havacılık - Kritik Parça Montajı",
  "Telekomünikasyon - Hassas Bağlantı İşlemleri",
  "Optik Endüstrisi - Lens ve Ayna Montajı",
  "Mikroelektronik - Çip Montaj ve Test",
  "Fotovoltaik - Güneş Paneli Üretimi",
  "Laboratuvar Otomasyonu - Test ve Analiz",
  "İlaç Endüstrisi - Tablet ve Kapsül İşleme",
]

export default function JHSeriesPage() {
      ...
      <section className="relative bg-gradient-to-br from-blue-900 via-blue-800 to-blue-900 text-white pt-20 pb-16">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <h1 className="text-4xl md:text-6xl font-bold mb-6">JH Serisi</h1>
            <p className="text-xl md:text-2xl text-blue-100 mb-8">
              Yüksek Hassasiyetli Endüstriyel Robotlar
            </p>
            <p className="text-lg text-blue-200 max-w-3xl mx-auto leading-relaxed">
              Maksimum hassasiyet ve hız sunan JH serisi robotlar,
              kritik uygulamalar için özel olarak tasarlanmıştır.
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-gray-600 max-w-3xl mx-auto">
                JH serisi robotlar, hassasiyet gerektiren endüstriyel uygulamalarda tercih edilir.
              </p>
            </div>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-gray-600 max-w-3xl mx-auto">
                Yüksek hassasiyet ve hız gerektiren uygulamalar için optimize edilmiş robotlar.
              </p>
            </div>

            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {jhSeriesRobots.map((robot, index) => (
                <Card
                  key={index}
      ...
      <section className="py-16 bg-blue-600 text-white">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl text-blue-100 mb-8 max-w-3xl mx-auto">
            Yüksek hassasiyet uygulamaları için teknik özellikler ve fiyat teklifleri.
          </p>
