...
const HSTC200Page = () => {
  ...
  const content = {
    tr: {
      ...
      subtitle: 'Profesyonel Endüstriyel Bilgisayar',
      description:
        'HST-C200 serisi, orta seviye endüstriyel uygulamalar için tasarlanmış güvenilir ve performanslı bilgisayar sistemleridir. Bu seri, endüstriyel ortamlarda kararlı çalışma sağlar.',
      features: [
        'Intel Core i5-13600 işlemci',
        '16GB DDR4 RAM',
        '512GB NVMe SSD',
        'Windows 11 Pro',
    ...
    en: {
      ...
      subtitle: 'Professional Industrial Computer',
      description:
        'The HST-C200 series are reliable and performant computer systems designed for mid-level industrial applications. This series ensures stable operation in industrial environments.',
      features: [
          ...
          <div className='space-y-6'>
            <div className='bg-white rounded-lg shadow-lg overflow-hidden'>
              <div className='aspect-w-16 aspect-h-9 bg-gray-200'>
                <div className='w-full h-64 bg-gradient-to-br from-green-400 to-blue-600 flex items-center justify-center'>
