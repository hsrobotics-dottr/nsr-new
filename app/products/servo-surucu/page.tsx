...
import { ArrowLeft, ExternalLink, MessageCircle, Settings } from 'lucide-react';
import Image from 'next/image';
import Link from 'next/link';
import { useState } from 'react';

// Servo Sürücü modelleri
const servoDrivers = [
  {
    model: 'HSS-LDE',
    power: '400W',
    ...
    features: ['Hassas Kontrol', 'Kolay Programlama', 'Kompakt Tasarım'],
    applications: ['Hassas Otomasyon', 'Robotik', 'CNC Sistemler'],
  },
  {
    model: 'HSS-LDE-F4',
    power: '750W',
    ...
    features: ['Yüksek Güç', 'Gelişmiş Kontrol', 'Endüstriyel Kalite'],
    applications: ['Ağır Otomasyon', 'Endüstriyel Robotik', 'Büyük Sistemler'],
  },
  {
    model: 'HSS-X6',
    power: '200W',
    ...
    features: ['Kompakt Boyut', 'Düşük Enerji', 'Kolay Entegrasyon'],
    applications: ['Küçük Otomasyon', 'Eğitim Sistemleri', 'Prototip Projeler'],
  },
];
...
const applicationAreas = [
  ...
  '3D Yazıcı ve Prototip Sistemleri',
  'Lazer Kesim ve Kaynak Sistemleri',
        ...
        <div className='container mx-auto max-w-8xl relative z-10'>
          <div className='max-w-4xl mx-auto text-center'>
            ...
            <p className='text-xl md:text-2xl text-blue-100 mb-8'>
              Hassas Kontrol ve Güçlü Performans
            </p>
            <p className='text-lg text-blue-200 max-w-3xl mx-auto leading-relaxed'>
              Farklı güç aralıklarında servo sürücülerimiz, hassas kontrol
          ...
          <div className='max-w-6xl mx-auto'>
            <div className='text-center mb-12'>
              ...
              <p className='text-lg text-gray-600 max-w-3xl mx-auto'>
                Servo sürücülerimiz, endüstrinin çeşitli alanlarında hassas
          ...
          <div className='max-w-7xl mx-auto'>
            <div className='text-center mb-12'>
              ...
              <p className='text-lg text-gray-600 max-w-3xl mx-auto'>
                ...
                sürücülerimizle ihtiyaçlarınıza uygun çözüm bulun.
              </p>
            </div>

            <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8'>
              {servoDrivers.map((driver, index) => (
                <Card
                  key={index}
                  ...
                  <CardContent className='space-y-4'>
                    <div className='grid grid-cols-3 gap-3'>
                      ...
                      <div className='bg-green-50 p-3 rounded-lg text-center'>
                        <div className='text-xs text-gray-600 mb-1'>Akım</div>
          ...
          <div className='bg-white rounded-2xl shadow-2xl max-w-2xl w-full max-h-[90vh] overflow-y-auto'>
            <div className='p-6 border-b border-gray-200'>
              ...
              <p className='text-gray-600 mt-2'>
                Servo Sürücü hakkında bilgi almak için formu doldurun.
              </p>
            </div>
              ...
              <form className='space-y-4'>
                ...
                <div>
                  ...
                  <textarea
                    ...
                    rows={4}
                    className='w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent'
                    placeholder='Servo Sürücü hakkında bilgi almak istiyorum...'
                  ></textarea>
                </div>
