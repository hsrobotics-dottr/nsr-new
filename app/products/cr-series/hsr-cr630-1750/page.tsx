...
payload: '30 kg',
reach: '1750mm',
description: `HSR-CR630-1750 endüstriyel işbirlikçi robot, çarpışma algılama, sürükleme öğretimi, yüksek hassasiyet, yüksek rijitlik ve yüksek koruma özelliklerine sahiptir. Geleneksel endüstriyel robotlar ve işbirlikçi robotlarla karşılaştırıldığında, endüstriyel robotların yüksek hız, yüksek hassasiyet ve yüksek rijitlik özelliklerine, aynı zamanda işbirlikçi robotların güvenlik, güvenilirlik ve kolay operasyon özelliklerine sahiptir. Farklı uygulama senaryolarıyla başa çıkabilir. Montaj, yükleme-boşaltma, yapıştırma, kaynak, vida sıkma ve diğer uygulama senaryoları için uygundur.`,
...
ioParameters: 'Dijital: 32-bit giriş, 30-bit çıkış',
reservedSignalLines: '24 bit (havacılık fişi bağlantısı)',
reservedAirway: '2xΦ8',
powerCapacity: '6.5kVA',
ratedPower: '6.2kW',
ratedVoltage: '380V',
ratedCurrent: '10A',
...
export default function HSRCR6301750Page() {
...
{t.product.reach}
      ...
      <div
        className='text-2xl font-bold text-gray-800'>1750mm      </div>
      </Card>
      </div>
...
{productData.environment.temperature}
      ...
      <div
        className='flex justify-between py-2 border-b border-gray-100'>
      <span
        className='text-gray-600 font-medium'>Nem      </span>
      <span
        className='font-semibold text-gray-800'>
{productData.environment.humidity}
      ...
      <div
        className='flex justify-between py-2 border-b border-gray-100'>
      <span
        className='text-gray-600 font-medium'>Diğer      </span>
      <span
...
{productData.additionalSpecs.powerCapacity}
      ...
      <div
        className='flex justify-between py-2 border-b border-gray-100'>
      <span
        className='text-gray-600 font-medium'>Nominal Güç      </span>
      <span
        className='font-semibold text-gray-800'>
