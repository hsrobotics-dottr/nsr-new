...
const productData = {
  ...
  movementSpeed: '0-1.5m/s',
  description: `Maliyet etkin: Lazer navigasyon, çevreyi değiştirmeden harita oluşturmanıza olanak tanır. İnsan-makine işbirliği: Lazer radar ve 360 derece sarıcı dokunma kenarı koruması ile donatılmış, insan-makine işbirliğinin güvenliğini artırır. Görünüm özelleştirmesini ve mekanik kol değişimini destekleyebilir.`,
  image: '/img/AMR/HSR-AMR605-400.png',
  specifications: {
    model: 'HSR-AMR605-400',
    mechanicalArm: {
      load: '5kg',
      workingRadius: '1000mm',
      repeatedPositioningAccuracy: '±0.02mm',
    },
    chassis: {
      maximumLoad: '400kg',
      positioningAccuracy: '±10mm',
      movingSpeed: '0-1.5m/s',
      navigationMode: 'Laser SLAM/Vision/IMU Fusion Navigation',
      driveMode: 'Differential',
      batterySpecifications: '48V31.5Ah, lithium iron phosphate battery',
...
export default function HSRAMR605400Page() {
      ...
      <section className='py-12 bg-white'>
        <div className='container mx-auto px-4 max-w-7xl'>
          ...
          <div className='grid lg:grid-cols-2 gap-8'>
            ...
            {/* Navigation and Drive Specifications */}
            <Card className='p-6'>
              <h3 className='text-xl font-semibold text-gray-800 mb-4 flex items-center'>
              ...
              <div className='space-y-3'>
                ...
                <div className='flex justify-between py-2 border-b border-gray-100'>
                  ...
                  <span className='font-semibold text-gray-800'>
                    {productData.specifications.chassis.driveMode}
                  </span>
                </div>
              </div>
            </Card>
