...
Ürün Merkezi
      ...
      <h1
        className='text-4xl md:text-6xl font-bold mb-6'>HC Serisi      </h1>
      <p
...
<div>
      <p
        className='text-gray-800 font-medium'>{area}      </p>
      </div>
      </div>
      </div>
))}
...
>
      <CardHeader
        className='pb-4'>
      <div
        className='relative h-48 bg-gray-100 rounded-lg overflow-hidden mb-4'>
<Image
src={robot.image}
alt={robot.model}
fill;
