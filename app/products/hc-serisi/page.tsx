...
export default function HCFSeriesPage() {
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-lg text-blue-200 max-w-3xl mx-auto leading-relaxed">
              Maksimum hassasiyet ve hız sunan HC serisi robotlar,
          ...
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-gray-600 max-w-3xl mx-auto">
                HC serisi robotlar, hassasiyet ve hız gerektiren endüstriyel uygulamalarda tercih edilir.
              </p>
            </div>
      ...
      <section className="py-16 bg-blue-600 text-white">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-3xl md:text-4xl font-bold mb-6">
            HC Serisi Hakkında Daha Fazla Bilgi
          </h2>
