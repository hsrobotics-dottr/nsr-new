...
category: 'CO Serisi (İşbirlikçi Robotlar)',
keywords: 'İşbirlikçi Robotlar',
axes: 6,
payload: '5 kg',
reach: '1005mm',
description: `HSR-CO605-1000 yeni nesil işbirlikçi robot güvenli, verimli, kullanımı kolay, kompakt, ergonomik, esnek programlama ve mevcut üretim hatlarına kolay entegrasyon özelliklerine sahiptir. İşbirliği alanında doğrudan insanlarla etkileşime girebilir, böylece üretim esnekliği maksimize edilebilir, daha fazla kullanıcının ihtiyaçlarını karşılayabilir, robotik yoluyla üretim emek seviyesini artırabilir, maliyetleri düşürebilir ve rekabet gücünü artırabilir.`,
...
reservedSignalLines: '6 pozisyon (Hummor konektör)',
reservedAirway: '-',
powerCapacity: '2kVA',
ratedPower: '1.2kW',
ratedVoltage: '48V',
...
export default function HSRCO6051000Page() {
...
{t.product.reach}
      ...
      <div
        className='text-2xl font-bold text-gray-800'>1005mm      </div>
      </Card>
      </div>
