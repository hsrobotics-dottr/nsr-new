...
const productData = {
  ...
  payload: '16 kg',
  reach: '1055mm',
  description: `HSR-CO616-1100, CO serisi işbirlikçi robotların tutarlı esnek modelleme tasarımını ve ergonomik tasarımını sürdürür. İyi etkileşim performansı, güvenlik ve kullanım kolaylığı, daha büyük hareket aralığı ve daha güçlü yük kapasitesi ile paletleme, yükleme-boşaltma, vida sıkma ve ödeme gibi çeşitli uygulama senaryoları için uygundur.`,
...
export default function HSRCO6161100Page() {
            ...
            <div className='space-y-6'>
              ...
              <div className='grid grid-cols-1 sm:grid-cols-3 gap-4'>
                ...
                <Card className='p-4 text-center border-2 border-gray-100'>
                  ...
                  <div className='text-2xl font-bold text-gray-800'>1055mm</div>
                </Card>
              </div>
          ...
          <div className='grid lg:grid-cols-2 gap-8'>
            ...
            <Card className='p-6'>
              ...
              <div className='space-y-3'>
                ...
                <div className='flex justify-between py-2 border-b border-gray-100'>
                  <span className='text-gray-600 font-medium'>Nominal Güç</span>
                  <span className='font-semibold text-gray-800'>
