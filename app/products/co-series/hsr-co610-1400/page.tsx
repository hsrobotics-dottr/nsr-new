...
payload: '10 kg',
reach: '1355mm',
description: `HSR-CO610-1400, CO serisi işbirlikçi robotların tutarlı esnek modelleme tasarımını ve ergonomik tasarımını sürdürür. İyi etkileşim performansı, güvenlik ve kullanım kolaylığı, daha büyük hareket aralığı ve daha güçlü yük kapasitesi ile paletleme, yükleme-boşaltma, vida sıkma ve ödeme gibi çeşitli uygulama senaryoları için uygundur.`,
...
reservedSignalLines: '4 pozisyon (M8 fiş bağlantısı)',
reservedAirway: '-',
powerCapacity: '2kVA',
ratedPower: '2kW',
ratedVoltage: '48V',
...
export default function HSRCO6101400Page() {
...
{t.product.reach}
      ...
      <div
        className='text-2xl font-bold text-gray-800'>1355mm      </div>
      </Card>
      </div>
