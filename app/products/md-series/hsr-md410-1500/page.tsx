...
const productData = {
  ...
  // Additional specifications for HSR-MD410-1500
  additionalSpecs: {
...
export default function HSRMD4101500Page() {
            ...
            <Card className='p-6'>
              ...
              <div className='space-y-3'>
                <div className='flex justify-between'>
                  <span className='text-gray-600'>J1:</span>
                  <span className='font-medium'>
                    {productData.allowedInertia.J1}
                  </span>
                </div>
                <div className='flex justify-between'>
                  <span className='text-gray-600'>J2:</span>
                  <span className='font-medium'>
                    {productData.allowedInertia.J2}
                  </span>
                </div>
                <div className='flex justify-between'>
                  <span className='text-gray-600'>J3:</span>
                  <span className='font-medium'>
                    {productData.allowedInertia.J3}
                  </span>
                </div>
                <div className='flex justify-between'>
                  <span className='text-gray-600'>J4:</span>
            ...
            <Card className='p-6'>
              ...
              <div className='space-y-3'>
                <div className='flex justify-between'>
                  <span className='text-gray-600'>J1:</span>
                  <span className='font-medium'>
                    {productData.allowedTorque.J1}
                  </span>
                </div>
                <div className='flex justify-between'>
                  <span className='text-gray-600'>J2:</span>
                  <span className='font-medium'>
                    {productData.allowedTorque.J2}
                  </span>
                </div>
                <div className='flex justify-between'>
                  <span className='text-gray-600'>J3:</span>
                  <span className='font-medium'>
                    {productData.allowedTorque.J3}
                  </span>
                </div>
                <div className='flex justify-between'>
                  <span className='text-gray-600'>J4:</span>
