...
{product.model}
      ...
      <p
        className='text-sm text-gray-600'>{product.title}      </p>
      </CardHeader>
...
{product.positionAccuracy}
      ...
      <div
        className='text-xs text-gray-600 mb-1'>Yük      </div>
      <div
...
{/* Detay Özellikler */}
      ...
      <span
        className='text-gray-600'>Yüzer Vuruş:      </span>
      <span
...
{product.floatingStroke}
      ...
      <div
        className='flex justify-between'>
      <span
        className='text-gray-600'>Ağırlık:      </span>
      <span
        className='font-medium'>
{product.bodyWeight}
      </span>
      ...
      <div
        className='flex justify-between'>
      <span
        className='text-gray-600'>Boyutlar:      </span>
      <span
        className='font-medium'>
...
Uygulama Alanları
      ...
      <div
        className='flex items-start space-x-3 py-2 border-b border-gray-100'>
      <div
        className='w-2 h-2 bg-green-600 rounded-full mt-2 flex-shrink-0'>      </div>
      <span
        className='text-gray-700 text-sm leading-relaxed'>
...
İletişim Modu
      ...
      <p
        className='text-gray-600'>I/O & Modbus RTU      </p>
      </div>
<div>
      <h4
        className='font-medium text-gray-700 mb-2'>
