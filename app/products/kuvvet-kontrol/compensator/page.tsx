...
const productData = {
  ...
  keywords: 'Kuvvet Kompansasyon Sistemleri',
  maxForce: '500N',
  accuracy: '0.5N',
  protection: 'IP67',
  ...
  image: '/img/industrial/KuvvetKontrol/Compensator.png',
  specifications: {
    model: 'Compensator',
    maxForce: '500N',
    accuracy: '0.5N',
  ...
  features: {
    ...
    calibration: 'Otomatik kalibrasyon',
  },
  applications: {
    testing: 'Ürün testi',
            ...
            <div className='space-y-6'>
              ...
              <div className='grid grid-cols-1 sm:grid-cols-3 gap-4'>
                <Card className='p-4 text-center border-2 border-blue-100 bg-blue-50'>
                  ...
                  <div className='text-2xl font-bold text-blue-600'>500N</div>
                </Card>
                <Card className='p-4 text-center border-2 border-gray-100'>
                  <div className='text-sm text-gray-600 mb-1'>
                    {t.product.accuracy}
                  </div>
                  <div className='text-2xl font-bold text-gray-800'>0.5N</div>
                </Card>
                <Card className='p-4 text-center border-2 border-gray-100'>
                  <div className='text-sm text-gray-600 mb-1'>
                    {t.product.protection}
                  </div>
                  <div className='text-2xl font-bold text-gray-800'>IP67</div>
                </Card>
              </div>
