...
forceFeedback: 'Kuvvet Geri Beslemesi',
precisionPositioning: 'Hassas Pozisyonlama',
lowLatency: 'Düşük Gecikme',
description: `Compensator, robot uç aracında kuvvet geri beslemesi ile hassas pozisyonlama sağlayan gelişmiş sistemdir. Bu sistem, montaj, test ve kalibrasyon operasyonları için optimize edilmiştir. Düşük gecikme süresi ile robot hareketlerinde hassas kontrol sağlar ve çeşitli endüstriyel uygulamalarda kullanılabilir.`,
image: '/img/forcecontrol/compensator.png',
    specifications: {
    model: 'Compensator',
material: 'Alüminyum Alaşımı',
weight: '0.8 kg',
...
'Robot uç aracında kuvvet geri beslemesi ile hassas pozisyonlama',
'Montaj, test ve kalibrasyon operasyonları için optimize edilmiş',
'Düşük gecikme süresi ile robot hareketlerinde hassas kontrol',
'Çeşitli endüstriyel uygulamalarda kullanılabilir',
...
precisionPositioning: 'Precision Positioning',
...
export default function CompensatorPage() {
...
{/* Quick Specs */}
      ...
      <div
        className='text-sm text-gray-600 mb-1'>Malzeme      </div>
      <div
...
{productData.specifications.weight}
      ...
      <Card
        className='p-4 text-center border-2 border-gray-100'>
      <div
        className='text-sm text-gray-600 mb-1'>Boyutlar      </div>
      <div
        className='text-2xl font-bold text-gray-800'>
...
{productData.specifications.model}
      ...
      <div
        className='flex justify-between py-2 border-b border-gray-100'>
      <span
        className='text-gray-600 font-medium'>Malzeme      </span>
      <span
        className='font-semibold text-gray-800'>
{productData.specifications.material}
      </span>
...
{productData.specifications.dimensions}
      ...
      <div
        className='flex justify-between py-2 border-b border-gray-100'>
      <span
        className='text-gray-600 font-medium'>Sıcaklık      </span>
      <span
        className='font-semibold text-gray-800'>
