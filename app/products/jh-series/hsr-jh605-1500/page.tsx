...
payload: '5 kg',
reach: '1494mm',
description: `HSR-JH605-1500, yüksek performanslı kaynak robotunun yeni neslidir. Yüksek rijitlik, yüksek hız, yüksek hassasiyet, güçlü stabilite, hızlı hareket tepkisi ve yüksek maliyet performansı avantajlarına sahiptir. Çeşitli endüstriyel kaynak alanlarında yaygın olarak kullanılabilir.`,
...
// Additional specifications for HSR-JH605-1500
    additionalSpecs: {
    teachPendantCable: '8 metre',
mainUnitCabinetCable: '5 metre',
ioParameters: 'Dijital miktar: 32-bit giriş (NPN), 32-bit çıkış (NPN)',
reservedSignalLines: '24 bit, 4 bit (havacılık fişi bağlantı modu: kaynak)',
reservedAirway: '1xΦ8',
...
export default function HSRJH6051500Page() {
