...
category: 'JH Serisi (Endüstriyel Altı Eksenli)',
keywords: 'Endüstriyel Robotlar',
axes: 6,
payload: '20 kg',
reach: '1800mm',
description: `HSR-JH620-1800, 1.8 metre kol açıklığı ve 20KG yük kapasitesine sahip yüksek hızlı ve yüksek hassasiyetli evrensel bir robotur. Ön kol ve bilek büyük çaplı içi boş olarak tasarlanmıştır. Ön kolun maksimum delik çapı φ45mm ve bileğin maksimum delik çapı φ50mm'dir. Kaynak ve parlatma uygulamalarında alet boru hatlarının düzenlenmesi uygundur, uç boru hatlarının müdahalesini minimize eder ve ön kolun koruma seviyesi IP67'ye ulaşır, makine aletlerinin yükleme ve boşaltma gibi çalışma koşulları için uygundur, son derece yüksek hız ve hassasiyet göstergeleri şirketlerin kalite ve verimliliği artırmasına etkili bir şekilde yardımcı olacak ve beklenenin üzerinde getiri elde etmelerini sağlayacaktır.`,
...
// Additional specifications for HSR-JH620-1800
    additionalSpecs: {
    teachPendantCable: '8 metre',
mainUnitCabinetCable: '5 metre',
ioParameters: 'Dijital miktar: 32-bit giriş (NPN), 31-bit çıkış (NPN)',
reservedSignalLines: '24 bit (havacılık fişi bağlantısı: kaynak)',
reservedAirway: '3xφ8',
powerCapacity: '6.9kVA',
ratedPower: '5kW',
ratedVoltage: '3 faz 380V',
ratedCurrent: '9.3A',
protectionLevel: 'IP54 (kol IP67)',
installationMethod: 'Zemin/ters/yan asma',
weight: '280kg',
...
export default function HSRJH6201800Page() {
