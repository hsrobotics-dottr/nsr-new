...
const productData = {
  ...
  payload: '18 kg',
  reach: '620mm',
  description: `HSR-JH620-1800, Huashu Robotics'den gelen yüksek performanslı SCARA (Selective Compliance Assembly Robot Arm) robotudur. Montaj, taşıma ve hassas konumlandırma uygulamaları için idealdir. Kompakt tasarımı ve yüksek hızı ile üretim hatlarında maksimum verimlilik sağlar.`,
            ...
            <Card className='p-6'>
              ...
              <div className='space-y-3'>
                ...
                <div className='flex justify-between py-2 border-b border-gray-100'>
                  ...
                  <span className='font-semibold text-gray-800'>16kg</span>
                </div>
                <div className='flex justify-between py-2 border-b border-gray-100'>
                  <span className='text-gray-600 font-medium'>
                    Koruma Seviyesi
