...
payload: '15 kg',
reach: '2000mm',
description: `HSR-JH615-2000, 2m kol açıklığı ve 15KG yük kapasitesine sahip yüksek hızlı ve yüksek hassasiyetli evrensel bir robotur. Ön kol ve bilek büyük çaplı içi boş olarak tasarlanmıştır. Ön kolun maksimum delik çapı φ42mm ve bileğin maksimum delik çapı φ50mm'dir. Kaynak ve parlatma uygulamalarında alet boru hatlarının düzenlenmesi uygundur, uç boru hatlarının müdahalesini minimize eder ve ön kolun koruma seviyesi IP67'ye ulaşır, yükleme ve boşaltma için uygundur, son derece yüksek hız ve hassasiyet göstergeleri şirketlerin kalite ve verimliliği artırmasına etkili bir şekilde yardımcı olacak ve beklenenin üzerinde getiri elde etmelerini sağlayacaktır.`,
...
// Additional specifications for HSR-JH615-2000
    additionalSpecs: {
...
export default function HSRJH6152000Page() {
