...
const HSRJH6152000Page = () => {
  ...
  const content = {
    tr: {
      title: 'HSR-JH615-2000 Serisi',
      subtitle: 'Yüksek Performanslı Endüstriyel Bilgisayar',
      description:
        'HSR-JH615-2000 serisi, endüstriyel uygulamalar için özel olarak tasarlanmış güçlü ve güvenilir bilgisayar sistemleridir. Bu seri, zorlu endüstriyel ortamlarda bile kesintisiz çalışma sağlar.',
      features: [
    ...
    en: {
      title: 'HSR-JH615-2000 Series',
      subtitle: 'High Performance Industrial Computer',
      description:
        'The HSR-JH615-2000 series are powerful and reliable computer systems specially designed for industrial applications. This series ensures uninterrupted operation even in challenging industrial environments.',
      features: [
              ...
              <div className='aspect-w-16 aspect-h-9 bg-gray-200'>
                <div className='w-full h-64 bg-gradient-to-br from-blue-400 to-purple-600 flex items-center justify-center'>
                  <div className='text-center text-white'>
                    ...
                    <p className='text-xl font-semibold'>HSR-JH615-2000</p>
...
export default HSRJH6152000Page;
