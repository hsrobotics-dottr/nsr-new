...
const productData = {
  ...
  payload: '15 kg',
  reach: '615mm',
  description: `HSR-JH615-2000, Huashu Robotics'den gelen yüksek performanslı SCARA (Selective Compliance Assembly Robot Arm) robotudur. Montaj, taşıma ve hassas konumlandırma uygulamaları için idealdir. Kompakt tasarımı ve yüksek hızı ile üretim hatlarında maksimum verimlilik sağlar.`,
            ...
            <Card className='p-6'>
              ...
              <div className='space-y-3'>
                <div className='flex justify-between py-2 border-b border-gray-100'>
                  ...
                  <span className='font-semibold text-gray-800'>30kg</span>
                </div>
                <div className='flex justify-between py-2 border-b border-gray-100'>
                  <span className='text-gray-600 font-medium'>
                    Dolap Ağırlığı
