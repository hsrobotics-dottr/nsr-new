...
payload: '30 kg',
reach: '1800mm',
description: `HSR-JH630-1800, 1.8 metre kol açıklığı ve 30KG yük kapasitesine sahip yüksek hızlı, yüksek hassasiyetli, genel amaçlı bir robotur. Ön kol ve bilek, ön kol için φ45mm ve bilek için φ50mm maksimum delik çapına sahip büyük çaplı içi boş tasarım özelliğine sahiptir. Bu, kaynak ve parlatma uygulamalarında alet hatlarının yönlendirilmesini kolaylaştırır ve kol ucu müdahalesini minimize eder. Ön kol IP67 koruma derecesine sahiptir ve makine aleti yükleme ve boşaltma uygulamaları için uygundur. Yüksek hızı ve hassasiyeti, şirketlerin kalite ve verimliliği artırmasına etkili bir şekilde yardımcı olacak, beklenenin üzerinde getiri elde etmelerini sağlayacaktır.`,
...
// Additional specifications for HSR-JH630-1800
    additionalSpecs: {
    teachPendantCable: '8m',
mainUnitCabinetCable: '5m',
ioParameters: 'Digital: 32-bit input (NPN), 31-bit output (NPN)',
reservedSignalLines: '24-bit (Aviation connector wiring method: welding)',
reservedAirway: '3*φ8',
powerCapacity: '6.9KVA',
ratedPower: '5kW',
ratedVoltage: 'Three-phase 380V',
ratedCurrent: '9.3A',
protectionLevel: 'IP54 (Arm IP67)',
installationMethod: 'Floor/Inverted/Side/Any direction mounting',
weight: '280kg',
...
export default function HSRJH6301800Page() {
