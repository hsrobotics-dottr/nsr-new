...
keywords: 'Hızlı Değiştirilen Disk, HST-C500, HSRobot',
capacity: '500mm',
material: 'Çelik',
weight: '12.5kg',
description: `HST-C500, Huashu Robotics'den gelen yüksek kaliteli hızlı değiştirilen disk sistemidir. 500mm kapasite ile çok büyük parçalar için ideal olan bu ürün, hassas işleme ve hızlı değişim özellikleri sunar. Endüstriyel uygulamalarda güvenilir performans ve uzun ömür garantisi verir.`,
image: '/img/quick/HST-C500.png',
    specifications: {
    capacity: '500mm',
material: 'Çelik',
weight: '12.5kg',
dimensions: 'Φ100 x 60mm',
surfaceFinish: 'Ra 0.8',
hardness: 'HRC 58-62',
tolerance: '±0.06mm',
},
features: ['Yüksek hassasiyet', 'Hızlı değişim', 'Uzun ömür', 'Kolay bakım'],
applications: [
'Çok büyük parça işleme',
'Hassas delme',
'Kontrol sistemleri',
'Otomasyon',
],
advantages: [
'Yüksek kalite çelik malzeme',
'Hassas tolerans',
