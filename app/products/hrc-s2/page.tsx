...
const productData = {
  ...
  description: `HRC-S2 elektrik panosu, endüstriyel robotik uygulamalar için tasarlanmış yüksek güçlü kontrol kabinidir. 19KW güç kapasitesi ile büyük sistemlerde güvenli çalışma sağlar. Modbus TCP, Ethernet IP ve seri iletişim protokollerini destekleyerek esnek entegrasyon imkanı sunar. Kompakt tasarımı ve gelişmiş koruma özellikleri ile çeşitli endüstriyel ortamlarda kullanıma uygundur.`,
  image: '/img/MotionController/hrc-s2.png',
  specifications: {
    structural: {
      dimensions: '653x552.5x730mm',
      weight: '80kg',
    ...
    additionalCabinet: {
      ...
      installableDrives:
        '1~3 adet 20A güç sürücü kurulabilir, 20A güç sürücü 1~3 adet kurulabilir',
      dimensions: '640x500x650mm',
      remarks:
        'S2 serisi kontrol kabini ile kullanıldığında istiflenebilir, alan tasarrufu sağlar',
    },
  },
};
...
const translations = {
  tr: {
    product: {
      ...
      axis1to3: '1, 2, 3 Eksen',
      axis4to6: '4, 5, 6 Eksen',
...
export default function HRCS2Page() {
            ...
            <Card className='p-6'>
              ...
              <div className='space-y-3'>
                ...
                <div className='flex justify-between py-2 border-b border-gray-100'>
                  ...
                  <span className='font-semibold text-gray-800'>
                    {productData.specifications.power.axisPower.axis1to3}
                  </span>
                </div>
                <div className='flex justify-between py-2 border-b border-gray-100'>
                  <span className='text-gray-600 font-medium'>
                  ...
                  <span className='font-semibold text-gray-800'>
                    {productData.specifications.power.axisPower.axis4to6}
                  </span>
                </div>
              </div>
            </Card>
