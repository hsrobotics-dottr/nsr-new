...
payload: '300 kg',
reach: '3000mm',
description: `HSR-JR6300-3000 ağır yük robot serisi, inşaat malzemeleri, ev mobilyaları, otomotiv ve lityum batarya endüstrilerinde yaygın olarak kullanılmaktadır. 300KG süper büyük yük kapasitesi, 3m'ye kadar çalışma aralığı özelliklerine sahiptir ve yüksek hassasiyet ve yüksek güvenilirlik sunar.`,
...
// Additional specifications for HSR-JR6300-3000
    additionalSpecs: {
...
export default function HSRJR63003000Page() {
