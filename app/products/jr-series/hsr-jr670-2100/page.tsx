...
payload: '70 kg',
reach: '2154mm',
description: `HSR-JR670-2100, yüksek performanslı, genel amaçlı, orta yük kapasiteli eklemli bir robotur. Kendi geliştirilen kontrol teknolojisi ve yüksek performanslı servo motorlar kullanır. Hafif gövde tasarımı ve kontrol sistemi optimizasyonu sayesinde mükemmel performans elde eder. Yüksek performanslı motorlar, yüksek kaliteli redüktörler ve gelişmiş servo teknolojisi kullanarak, hızlı hareket hızı, yüksek tekrarlanan konumlandırma doğruluğu, büyük çalışma yarıçapı ve yüksek koruma özelliklerine sahiptir. Parlatma, taşıma, kaynak ve çeşitli endüstrilerde yükleme ve boşaltma gibi uygulamalar için çok uygundur.`,
...
// Additional specifications for HSR-JR670-2100
    additionalSpecs: {
    teachPendantCable: '8 metre',
mainUnitCabinetCable: '6 metre',
ioParameters: 'Dijital: 32-bit giriş (NPN), 31-bit çıkış (NPN)',
reservedSignalLines: '24 bit (Havacılık fişi: kaynak)',
reservedAirway: '4xΦ10',
powerCapacity: '12.2kVA',
ratedPower: '9.7kW',
ratedVoltage: '3 faz AC380V',
ratedCurrent: '18.5A',
protectionLevel: 'IP54 (Bilek IP67)',
...
export default function HSRJR6702100Page() {
