...
const productData = {
  ...
  payload: '7 kg',
  reach: '911.5mm',
  description: `HSR-JR607-910, Wasu Robot için başka bir küçük çok amaçlı altı eklemli robot olacak, kompakt yapı, küçük boyut, hafif ağırlık, yüksek eklem hızı, hızlı dinamik yanıt, daha yüksek koruma seviyesi ve çeşitli su ortamlarına kolay yanıt ile. Bu altı eksenli robot öncelikle yeni enerji, tüketici elektronik bileşen montajı vb. alanları hedefliyor ve 3C endüstrisinde yüksek hızlı ve yüksek hassasiyetli montaj robotu olarak konumlandırılıyor.`,
  ...
  // Additional specifications for HSR-JR607-910
  additionalSpecs: {
    teachPendantCable: '8 metre',
    mainUnitCabinetCable: '3 metre',
    ioParameters: 'Dijital: 32 giriş, 31 çıkış (genişletilebilir)',
    reservedSignalLines: '12 pozisyon (havacılık fişi bağlantısı)',
    reservedAirway: '4Φ4',
    powerCapacity: '1.56kVA',
    ratedPower: '1.25kW',
    ratedVoltage: '220V',
    ratedCurrent: '6.5A',
    protectionLevel: 'IP67',
    installationMethod: 'Zemin Kurulumu, Ters Kurulum, Yan Asma Kurulumu',
    weight: '52kg',
...
export default function HSRJR607910Page() {
        ...
        <div className='container mx-auto px-4 max-w-7xl'>
          ...
          <div className='grid lg:grid-cols-2 gap-8'>
            ...
            <Card className='p-6'>
              <h3 className='text-xl font-semibold text-gray-800 mb-4 flex items-center'>
                <Zap className='w-5 h-5 mr-2 text-blue-600' />
                {t.product.ratedSpeed}
              </h3>
              <div className='space-y-3'>
                {Object.entries(productData.ratedSpeed).map(([key, value]) => (
                  <div
                    key={key}
                    className='flex justify-between py-2 border-b border-gray-100'
                  >
