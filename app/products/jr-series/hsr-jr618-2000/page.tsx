...
payload: '18 kg',
reach: '2000mm',
description: `HSR-JR618-2000, yüksek hassasiyet, güçlü ivme yeteneği, iyi rijitlik, bilek koruma seviyesi IP67'ye kadar çıkma gibi avantajlara sahiptir ve bilek, geleneksel bileklerden daha kompakt yapıya ve daha büyük hareket aralığına sahiptir. Makine aleti yükleme ve boşaltma, paletleme, montaj, cilalama ve kaynak gibi endüstri uygulama pazarlarında kolayca başa çıkabilir.`,
...
// Additional specifications for HSR-JR618-2000
    additionalSpecs: {
    teachPendantCable: '8 metre',
mainUnitCabinetCable: '6 metre',
ioParameters: 'Dijital: 32-bit giriş (NPN PNP olabilir) 31-bit çıkış (NPN)',
reservedSignalLines: '24 pozisyon (havacılık fişi bağlantısı)',
reservedAirway: '2xΦ8',
powerCapacity: '5.6kVA',
ratedPower: '4.3kW',
ratedVoltage: '3 faz 380V',
ratedCurrent: '8.1A',
protectionLevel: 'IP54',
installationMethod: 'Zemin, Yan Asma ve Ters Kurulum',
weight: '280kg',
cabinetWeight: '15kg',
...
export default function HSRJR6182000Page() {
