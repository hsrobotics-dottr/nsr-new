...
payload: '15 kg',
reach: '2000mm',
description: `HSR-JR615-2000, 2m kol açıklığı ve 15KG yük kapasitesine sahip yüksek hızlı, yüksek hassasiyetli, genel amaçlı bir robottur. Ön kol ve bilek, büyük çaplı içi boş tasarım özelliğine sahiptir, ön kol için maksimum delik çapı φ45mm ve bilek için φ50mm'dir. Bu, kaynak ve cilalama uygulamalarında takım hatlarının yönlendirilmesini kolaylaştırır ve kol ucu müdahalesini minimize eder. Ön kol IP67 koruma derecesine sahiptir ve makine aleti yükleme ve boşaltma uygulamaları için uygundur. Yüksek hızı ve hassasiyeti, şirketlerin kalite ve verimliliği artırmasına etkili bir şekilde yardımcı olacak ve beklenenin üzerinde getiri elde etmelerini sağlayacaktır.`,
...
// Additional specifications for HSR-JR615-2000
    additionalSpecs: {
...
export default function HSRJR6152000Page() {
