...
const productData = {
  ...
  payload: '7 kg',
  reach: '730mm',
  description: `HSR-JR607-730, Huashu Robotics'den gelen kompakt ve çok yönlü bir altı eksenli endüstriyel robottur. Yüksek hassasiyet ve hız ile montaj, taşıma ve kalite kontrol uygulamaları için idealdir. Hafif tasarımı ve esnek kurulum seçenekleri ile çeşitli üretim ortamlarında kullanılabilir.`,
            ...
            <Card className='p-6'>
              ...
              <div className='space-y-3'>
                <div className='flex justify-between py-2 border-b border-gray-100'>
                  ...
                  <span className='font-semibold text-gray-800'>32kg</span>
                </div>
                <div className='flex justify-between py-2 border-b border-gray-100'>
                  <span className='text-gray-600 font-medium'>
                    Dolap Ağırlığı
                  </span>
                  <span className='font-semibold text-gray-800'>15kg</span>
                </div>
                <div className='flex justify-between py-2 border-b border-gray-100'>
                  <span className='text-gray-600 font-medium'>
                    Koruma Seviyesi
