...
payload: '50 kg',
reach: '2400mm',
description: `HSR-JR650-2400, orta boyutlu yük robotları, paletleme, kaynak, taşıma alanlarında kullanılan orta boyutlu yük avantajları özellikle belirgindir, işletme zeka derecesini artırmaya, işletme üretim güvenliğini güçlendirmeye yardımcı olur. HSR-JR650 robotunun maksimum yük kapasitesi 50kg ve maksimum kol genişlemesi 2400mm'dir. Takım ve bağlantı elemanlarının makul tasarımından sonra, robot 0.08mm'den fazla olmayan tekrarlanan konumlandırma doğruluğu ile tekrarlayan işleri gerçekleştirebilir, taşıma, kesme, parlatma, paletleme ve diğer endüstrilerde yaygın olarak kullanılabilir.`,
...
// Additional specifications for HSR-JR650-2400
    additionalSpecs: {
    teachPendantCable: '8 metre',
mainUnitCabinetCable: '8 metre',
ioParameters: 'Dijital miktar: 32-bit giriş (NPN), 31-bit çıkış (NPN)',
reservedSignalLines: '26 bit (havacılık fişi bağlantısı: kaynak)',
reservedAirway: '2xΦ10',
powerCapacity: '11kVA',
ratedPower: '8.8kW',
ratedVoltage: '3 faz AC380V',
ratedCurrent: '16.8A',
protectionLevel: 'IP54 (kol IP65)',
installationMethod: 'Zemin',
weight: '750kg',
cabinetWeight: '80kg',
...
export default function HSRJR6502400Page() {
