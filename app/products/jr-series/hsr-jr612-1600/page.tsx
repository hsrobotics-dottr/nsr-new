...
payload: '12 kg',
reach: '1551mm',
description: `Huashu HSR-JR612-1600, 12 kg yük kapasitesi, ±0.06 mm tekrar konumlandırma doğruluğu ve 1551 mm çalışma yarıçapına sahip yüksek performanslı, genel amaçlı, küçük yük kapasiteli eklemli bir robottur. Bağımsız olarak geliştirilen kontrol teknolojisi ve yüksek performanslı servo motorlar kullanarak aynı sınıftaki robotlar arasında büyük kol açıklığı ve büyük yük kapasitesi elde eder. Hızlı ve hassas hareket için yüksek rijitlik yapısı ve gelişmiş servo teknolojisi benimser. Yüksek kaliteli bileşenler, olgun teknoloji ve katı üretim süreç kontrolü kullanarak, fabrikadan çıkmadan önce 5x24 saatten fazla kusursuz çalışır ve kararlı kalite sağlar. Huashu Robotics'in 3C, işleme ve ev aletleri endüstrilerindeki 10 yıllık uygulama deneyimini birleştirerek, taşıma, paletleme, makine yükleme ve boşaltma, damgalama, yapıştırma, cilalama ve kaynak gibi çeşitli alanlarda süreç uygulama desteği sağlayabilir, tümü bir arada işlevsellik elde eder ve otomatik ve akıllı üretimi hızlı bir şekilde gerçekleştirmenize yardımcı olur.`,
...
// Additional specifications for HSR-JR612-1600
    additionalSpecs: {
...
ratedCurrent: '19A',
protectionLevel: 'IP54/IP65 (kol)',
installationMethod: 'Zemin Kurulumu, Ters Kurulum, Yan Kurulum',
weight: '182kg',
cabinetWeight: '12kg',
cabinetProtectionLevel: 'IP20/IP54 (opsiyonel)',
},
};
...
export default function HSRJR6121600Page() {
