...
const productData = {
  ...
  payload: '210 kg',
  reach: '2700mm',
  description: `HSR-JR6210-2700 robotunun tüm sistemi kompakt bir yapıya sahiptir. Gövde tam dişli rijit transmisyon kullanır, yüksek tekrarlanan konumlandırma doğruluğu, düşük arıza oranı, basit operasyon, otobüs yapısı, uygun genişletme ve uygulama özellikleri ile taşıma, paletleme, nokta kaynak, parlatma ve diğer uygulamalarda kullanılabilir.`,
  ...
  // Additional specifications for HSR-JR6210-2700
  additionalSpecs: {
    teachPendantCable: '8 metre',
    mainUnitCabinetCable: '8 metre',
    ioParameters: 'Dijital miktar: 32 giriş (NPN), 30 çıkış (NPN)',
    powerCapacity: '18.5kVA',
    ratedPower: '15kW',
...
export default function HSRJR62102700Page() {
