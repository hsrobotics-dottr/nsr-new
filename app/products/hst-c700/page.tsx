...
keywords: 'HST-C700, hızlı değiştirilen disk, takım değiştirici, HSRobot',
capacity: '700 kg',
material: 'Havacılık Alüminyumu',
weight: '29 kg',
description:
'HST-C700, 700 kg yük kapasitesine sahip yüksek hassasiyetli hızlı değiştirilen disk sistemidir. En ağır endüstriyel uygulamalar için tasarlanmıştır.',
image: '/img/quick/HST-C700.png',
    specifications: {
    capacity: '700 kg',
material: 'Havacılık Alüminyumu',
weight: '29 kg',
dimensions: '264x264mm',
surfaceFinish: 'Yüksek Hassasiyet',
hardness: 'Dayanıklı',
tolerance: '±0.025mm',
loadCapacity: '700 kg',
allowableBendingMoment: '4900 N·m',
allowableTorque: '3600 N·m',
lockingForce: '65000 N',
overallDimension: '264x264mm',
lockedStateThickness: '142mm',
repeatedPositioningAccuracy: '±0.025mm',
...
HST-C700 hızlı değiştirilen disk sisteminin detaylı teknik;
parametreleri
      </p>
      </div>
...
Ürün Özellikleri ve Avantajları
      ...
      <p
        className='text-lg text-gray-600 max-w-2xl mx-auto'>
HST-C700'in sunduğu gelişmiş özellikler ve endüstriyel avantajları
      </p>
      </div>
