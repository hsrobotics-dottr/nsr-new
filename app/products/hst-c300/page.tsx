...
const HSTC300Page = () => {
  ...
  const content = {
    tr: {
      ...
      subtitle: 'Gelişmiş Endüstriyel Bilgisayar',
      description:
        'HST-C300 serisi, yüksek performans gerektiren endüstriyel uygulamalar için tasarlanmış gelişmiş bilgisayar sistemleridir. Bu seri, karmaşık iş yüklerini verimli şekilde yönetir.',
      features: [
        'Intel Core i7-13700 işlemci',
        '32GB DDR5 RAM',
        '1TB NVMe SSD',
        'Windows 11 Pro',
        'Endüstriyel sıcaklık aralığı (-30°C ile +65°C)',
        'IP66 koruma sınıfı',
        'Gelişmiş seri port desteği',
      ...
      specifications: {
        ...
        os: 'Windows 11 Pro',
        temperature: '-30°C ile +65°C',
        protection: 'IP66',
        ports:
          '6x USB 3.2, 4x USB 2.0, 4x Serial, 2x Ethernet, 2x DisplayPort, 2x HDMI',
      },
      applications: [
        'Gelişmiş endüstriyel otomasyon',
        'Karmaşık makine kontrol sistemleri',
        'Gerçek zamanlı veri analizi',
        'Görüntü işleme ve analiz',
        'Gelişmiş kalite kontrol',
        'Karmaşık üretim hattı yönetimi',
      ],
      benefits: [
        'Yüksek performans ve verimlilik',
        'Gelişmiş endüstriyel ortam uyumluluğu',
        'Geniş sıcaklık aralığı',
        'Gelişmiş port ve bağlantı desteği',
        'Kolay entegrasyon ve ölçeklendirme',
        'Güvenilir endüstriyel tasarım',
      ],
      cta: 'Teklif Alın',
    ...
    en: {
      ...
      subtitle: 'Advanced Industrial Computer',
      description:
        'The HST-C300 series are advanced computer systems designed for industrial applications requiring high performance. This series efficiently manages complex workloads.',
      features: [
        'Intel Core i7-13700 processor',
        '32GB DDR5 RAM',
        '1TB NVMe SSD',
        'Windows 11 Pro',
        'Industrial temperature range (-30°C to +65°C)',
        'IP66 protection class',
        'Advanced serial port support',
        '2.5 Gigabit Ethernet',
      ...
      applications: [
        ...
        'Complex machine control systems',
      ...
      benefits: [
        ...
        'Advanced industrial environment compatibility',
        'Wide temperature range',
        'Advanced port and connectivity support',
