...
// Kompozit Robot kategorileri
const compositeRobotCategories = [
  {
    id: 'kompozit-robot',
    title: 'Kompozit Robot',
    description:
      'Özel uygulamalar için geliştirilmiş kompozit robotik sistemler',
...
export default function CompositeRobotsPage() {
        ...
        <div className='container mx-auto max-w-8xl relative z-10'>
          <div className='max-w-4xl mx-auto text-center'>
            ...
            <p className='text-xl md:text-2xl text-blue-100 mb-8'>
              Özel Uygulamalar İçin Geliştirilmiş Kompozit Robotik Sistemler
            </p>
            <p className='text-lg text-blue-200 max-w-3xl mx-auto leading-relaxed'>
              Standart robot çözümlerinin yetersiz kaldığı özel uygulamalar için
              tasarlanmış, yüksek adaptasyon kabiliyetine sahip kompozit robotik
              sistemler.
            </p>
          </div>
        </div>
          ...
          <div className='max-w-7xl mx-auto'>
            <div className='text-center mb-12'>
              ...
              <p className='text-lg text-gray-600 max-w-3xl mx-auto'>
                Özel uygulama ihtiyaçlarınıza uygun kompozit robotik çözümler
                ile üretim süreçlerinizi optimize edin.
              </p>
            </div>

            <div className='grid grid-cols-1 gap-8 max-w-2xl mx-auto'>
              {compositeRobotCategories.map((category, index) => (
                <Card
                  key={index}
          ...
          <div className='bg-white rounded-2xl shadow-2xl max-w-2xl w-full max-h-[90vh] overflow-y-auto'>
            <div className='p-6 border-b border-gray-200'>
              ...
              <p className='text-gray-600 mt-2'>
                Kompozit robotlar hakkında bilgi almak için formu doldurun.
              </p>
            </div>
              ...
              <form className='space-y-4'>
                ...
                <div>
                  ...
                  <textarea
                    ...
                    rows={4}
                    className='w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent'
                    placeholder='Kompozit robotlar hakkında bilgi almak istiyorum...'
                  ></textarea>
                </div>
