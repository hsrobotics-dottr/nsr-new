...
// İşbirlikçi Robot kategorileri
const collaborativeRobotCategories = [
  {
    id: 'cr-serisi',
    title: 'CR Serisi',
    description: 'Yüksek yük kapasitesine sahip işbirlikçi robotlar',
    image: '/img/Collaborative/CR/HSR-CR605-790.png',
    specs: {
      type: 'İşbirlikçi Robot',
      payload: '5-25 kg',
      reach: '790-2000 mm',
      applications: 'Ağır Yük Taşıma, Montaj, Transfer',
    },
    features: ['Yüksek Yük Kapasitesi', 'Güvenli İşbirliği', 'Esnek Uygulama'],
    href: '/products/cr-serisi',
  },
  {
    id: 'co-serisi',
    title: 'CO Serisi',
    description: 'Hassas işlemler için tasarlanmış işbirlikçi robotlar',
    image: '/img/Collaborative/CO/HSR-CO605-1000.png',
    specs: {
      type: 'İşbirlikçi Robot',
      payload: '5-16 kg',
      reach: '1000-1400 mm',
      applications: 'Hassas Montaj, Test, Paketleme',
    },
    features: ['Yüksek Hassasiyet', 'Güvenli Çalışma', 'Kolay Programlama'],
    href: '/products/co-serisi',
  },
];

export default function CollaborativeRobotsPage() {
        ...
        <div className='container mx-auto max-w-8xl relative z-10'>
          <div className='max-w-4xl mx-auto text-center'>
            ...
            <p className='text-xl md:text-2xl text-blue-100 mb-8'>
              CR ve CO Serisi İşbirlikçi Robotlar
            </p>
            <p className='text-lg text-blue-200 max-w-3xl mx-auto leading-relaxed'>
              İnsanlarla güvenli bir şekilde çalışabilen, yüksek hassasiyetli ve
              esnek işbirlikçi robot çözümleri ile üretim verimliliğinizi
              artırın.
            </p>
          </div>
        </div>
          ...
          <div className='max-w-7xl mx-auto'>
            <div className='text-center mb-12'>
              ...
              <p className='text-lg text-gray-600 max-w-3xl mx-auto'>
                ...
                uygun işbirlikçi robot çözümü seçin.
              </p>
            </div>

            <div className='grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto'>
              {collaborativeRobotCategories.map((category, index) => (
                <Card
                  key={index}
      ...
      <section className='py-16 bg-blue-600 text-white'>
        <div className='container mx-auto max-w-8xl text-center'>
          <h2 className='text-3xl md:text-4xl font-bold mb-6'>
            İşbirlikçi Robotlar Hakkında Daha Fazla Bilgi
          </h2>
          ...
          <div className='bg-white rounded-2xl shadow-2xl max-w-2xl w-full max-h-[90vh] overflow-y-auto'>
            <div className='p-6 border-b border-gray-200'>
              ...
              <p className='text-gray-600 mt-2'>
                İşbirlikçi robotlar hakkında bilgi almak için formu doldurun.
              </p>
            </div>
              ...
              <form className='space-y-4'>
                ...
                <div>
                  ...
                  <textarea
                    ...
                    rows={4}
                    className='w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent'
                    placeholder='İşbirlikçi robotlar hakkında bilgi almak istiyorum...'
                  ></textarea>
                </div>
