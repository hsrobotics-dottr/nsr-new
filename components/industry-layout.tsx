          ...
          <div className='max-w-6xl mx-auto'>
            <div className='grid grid-cols-1 lg:grid-cols-2 gap-8'>
              {images.map((image, index) => (
                <div
                  key={index}
                  className='relative h-80 bg-gray-100 rounded-xl overflow-hidden shadow-lg'
                >
                  <img
                    src={image}
                  ...
                  <div className='absolute bottom-4 left-4 text-white'>
                    ...
                    <p className='text-sm opacity-90'>
                      {index === 0
                        ? 'Hassas ve verimli otomasyon'
                        : 'Güvenli ve sürdürülebilir üretim'}
                    </p>
                  </div>
                </div>
              ))}
      ...
      <section className='py-16 bg-blue-600 text-white'>
        <div className='container mx-auto px-4 text-center'>
          ...
          <p className='text-xl text-blue-100 mb-8 max-w-3xl mx-auto'>
            Bu endüstri sektörü için özel olarak tasarlanmış robotik
            çözümlerimiz hakkında daha fazla bilgi alın.
          </p>
