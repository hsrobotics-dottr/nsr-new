...
export default function InteractiveRobotArm() {
  ...
  return (
    <div className="w-full h-64 md:h-80 bg-gray-900 rounded-2xl overflow-hidden relative">
      <svg ref={svgRef} viewBox="0 0 800 600" className="w-full h-full cursor-crosshair">
        {/* Base */}
        ...
        {isWelding && (
          <g>
            ...
            {/* Smoke */}
            <ellipse cx={torchX} cy={torchY} rx="8" ry="8" fill="rgba(200,200,200,0.4)" />

            {/* Bright welding light */}
            <circle cx={torchX} cy={torchY} r="15" fill="rgba(255,255,255,0.3)" />
          </g>
        )}
